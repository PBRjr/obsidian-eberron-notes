...
- [ ] Moment 1a: The Sanctum of the Broken Wing
...
* [ ] Moment 2: The Cabin and The Broken One
	...
	* Once convinced, he reveals certain **plot threads:**
		1. **The Mistake:** He explains that he alerted the _Lords of Dust_ to the shards by looking for them.
		2. **Hrothgar’s Curse:** He confirms that **Bjorn’s brother** is possessed by the shard's influence and wields the **Etherseraph** (the key to the Mourning/Silver Flame).
		3. **Draven’s Purpose:** He reveals he saved Draven but couldn't restore his memories. He confirms Draven’s purpose is to be a vessel of _Siberys_ light to counter the _Khyber_ darkness.
		4. **Forge’s Nature (Optional but cool):** As a creature of Siberys, Varyn might look at **Forge** and sense the "Perfect Balance" (Siberys conduit/Khyber soul taint) which makes Forge unique, hinting at the _Steelhardt_ secret without giving the technical schematic.

- [ ] Moment 3: The Legacy of Steel
...
*  **Forge's Nature:** Varyn looks at Forge with sadness/fascination. He is the balance Geralt's parents needed, but it happened to him by complete accident.

- [ ] Moment 4: The Hunt for Vorak (The Mission)
- Varyn sets the path forward.
- **The Problem:** Hrothgar holds a physical Dragonshard. If they use the untested Legacy Stone on him, the feedback could detonate the shard and wipe out the region (or kill the user).
- **The Solution:** They must hunt **Vorak** first.
    - Vorak is a "leaking vessel" (Quasi-Lich).
    - **Objective:** Use the Legacy Stone to absorb Vorak's corruption. This will (1) remove Vorak as a threat and (2) charge/calibrate the Stone so it is strong enough to sever Hrothgar's connection to the Dragonshard.
