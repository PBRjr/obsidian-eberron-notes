...
You target a creature you know on the same plane of existence. You or a willing creature you touch enters a trance state to act as a dream messenger. While in the trance, the messenger is [Incapacitated](Misc%20Files/CLI/rules/conditions.md#Incapacitated) and has a [Speed](Misc%20Files/CLI/rules/variant-rules/speed-xphb.md) of 0.
