...
- **Healing Light.** The target regains [Hit Points](Misc%20Files/CLI/rules/variant-rules/hit-points-xphb.md) equal to `4d12` plus your spellcasting ability modifier.  
...
Until the spell ends, [Bright Light](Misc%20Files/CLI/rules/variant-rules/bright-light-xphb.md) fills the Cylinder, and when you move on your turn, you can also move the Cylinder up to 30 feet.
