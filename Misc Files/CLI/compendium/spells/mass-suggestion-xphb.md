...
Each target must succeed on a Wisdom saving throw or have the [Charmed](Misc%20Files/CLI/rules/conditions.md#Charmed) condition for the duration or until you or your allies deal damage to the target. Each [Charmed](Misc%20Files/CLI/rules/conditions.md#Charmed) target pursues the suggestion to the best of its ability. The suggested activity can continue for the entire duration, but if the suggested activity can be completed in a shorter time, the spell ends for a target upon completing it.
