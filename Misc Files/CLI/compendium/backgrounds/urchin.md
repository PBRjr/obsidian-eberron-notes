...
- **Tool Proficiencies.** [Disguise kit](Misc%20Files/CLI/compendium/items/disguise-kit-xphb.md), [Thieves' tools](Misc%20Files/CLI/compendium/items/thieves-tools-xphb.md)  
- **Equipment.** A small knife, a map of the city you grew up in, a pet mouse, a token to remember your parents by, a set of [common clothes](Misc%20Files/CLI/compendium/items/common-clothes.md), and a belt [pouch](Misc%20Files/CLI/compendium/items/pouch-xphb.md) containing 10 gp  
