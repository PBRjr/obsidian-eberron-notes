...
- **Tool Proficiencies.** [Disguise kit](Misc%20Files/CLI/compendium/items/disguise-kit-xphb.md), one type of musical instrument  
- **Equipment.** An inexpensive but unusual weapon, such as a [trident](Misc%20Files/CLI/compendium/items/trident-xphb.md) or [net](Misc%20Files/CLI/compendium/items/net-xphb.md) (one of your choice), the favor of an admirer (love letter, lock of hair, or trinket), [costume clothes](Misc%20Files/CLI/compendium/items/costume-xphb.md), and a belt [pouch](Misc%20Files/CLI/compendium/items/pouch-xphb.md) containing 15 gp  
