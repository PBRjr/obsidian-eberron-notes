...
- **Skill Proficiencies.** [Deception](Misc%20Files/CLI/rules/skills.md#Deception), [Stealth](Misc%20Files/CLI/rules/skills.md#Stealth)  
- **Tool Proficiencies.** One type of gaming set, [thieves' tools](Misc%20Files/CLI/compendium/items/thieves-tools-xphb.md)  
- **Equipment.** A [crowbar](Misc%20Files/CLI/compendium/items/crowbar-xphb.md), a set of dark [common clothes](Misc%20Files/CLI/compendium/items/common-clothes.md) including a hood, and a belt [pouch](Misc%20Files/CLI/compendium/items/pouch-xphb.md) containing 15 gp  
