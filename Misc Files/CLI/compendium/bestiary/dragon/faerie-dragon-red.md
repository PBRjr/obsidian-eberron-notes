...
---
# [Faerie Dragon (Red)](Misc Files\CLI\compendium\bestiary\dragon/faerie-dragon-red.md)
...
- "desc": "The dragon's innate spellcasting ability is Charisma (spell save DC 13).\
    ...
    \n1/day each: [dancing lights](Misc%20Files/CLI/compendium/spells/dancing-lights-xphb.md),\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/dragon/token/faerie-dragon-red.webp"
```
^statblock
