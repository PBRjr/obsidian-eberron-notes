...
---
# [Ancient White Dragon](Misc Files\CLI\compendium\bestiary\dragon/ancient-white-dragon.md)
...
- "desc": "- Freezing fog fills a 20-foot-radius sphere centered on a point the dragon\
  ...
  "name": ""
- "desc": "At your discretion, a legendary ([adult](Misc%20Files/CLI/compendium/bestiary/dragon/adult-white-dragon.md)\
    \ or [ancient](Misc%20Files/CLI/compendium/bestiary/dragon/ancient-white-dragon.md))\
    ...
    \ throw or be [blinded](Misc%20Files/CLI/rules/conditions.md#Blinded) until initiative\
    \ count 20 on the next round.  \n- Whirling Wind. A strong wind blows in a\
    \ 30-foot-radius sphere centered on the dragon (see the \"Dungeon Master's Guide\"\
    \ for rules on \"strong wind\"). The dragon's flying is not affected by this wind,\
    \ which lasts until the next time the dragon uses a lair action or until the dragon\
    \ dies.  "
...
- "desc": "Any of these effects might appear in the area around a white dragon's lair,\
    ...
    \ than the dragon disadvantage on Dexterity ([Stealth](Misc%20Files/CLI/rules/skills.md#Stealth))\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/dragon/token/ancient-white-dragon.webp"
```
^statblock
