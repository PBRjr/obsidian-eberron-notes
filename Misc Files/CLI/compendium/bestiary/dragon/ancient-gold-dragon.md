...
---
# [Ancient Gold Dragon](Misc Files\CLI\compendium\bestiary\dragon/ancient-gold-dragon.md)
...
- "desc": "Each creature of the dragon's choice that is within 120 feet of the dragon\
    \ and aware of it must succeed on a DC 24 Wisdom saving throw or become [frightened](Misc%20Files/CLI/rules/conditions.md#Frightened)\
...
- "desc": "- The dragon glimpses the future, so it has advantage on attack rolls,\
  ...
  "name": ""
- "desc": "At your discretion, a legendary ([adult](Misc%20Files/CLI/compendium/bestiary/dragon/adult-gold-dragon.md)\
    \ or [ancient](Misc%20Files/CLI/compendium/bestiary/dragon/ancient-gold-dragon.md))\
    ...
    \ or be [charmed](Misc%20Files/CLI/rules/conditions.md#Charmed) by the dragon\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/dragon/token/ancient-gold-dragon.webp"
```
^statblock
