...
---
# [Adult Black Dragon](Misc Files\CLI\compendium\bestiary\dragon/adult-black-dragon.md)
...
- "desc": "- Pools of water that the dragon can see within 120 feet of it surge outward\
    ...
    \ the water and knocked [prone](Misc%20Files/CLI/rules/conditions.md#Prone). \
    ...
    \ creature with [darkvision](Misc%20Files/CLI/rules/senses.md#Darkvision) can't\
  ...
  "name": ""
- "desc": "At your discretion, a legendary ([adult](Misc%20Files/CLI/compendium/bestiary/dragon/adult-black-dragon.md)\
    \ or [ancient](Misc%20Files/CLI/compendium/bestiary/dragon/ancient-black-dragon.md))\
    ...
    \ must succeed on a DC 15 Strength saving throw or be [restrained](Misc%20Files/CLI/rules/conditions.md#Restrained)\
...
- "desc": "Any of these effects might appear in the area around a black dragon's lair,\
    ...
    \ within 6 miles of the lair, imposing disadvantage on Dexterity ([Stealth](Misc%20Files/CLI/rules/skills.md#Stealth))\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/dragon/token/adult-black-dragon.webp"
```
^statblock
