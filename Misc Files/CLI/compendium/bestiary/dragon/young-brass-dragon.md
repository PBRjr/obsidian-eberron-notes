...
---
# [Young Brass Dragon](Misc Files\CLI\compendium\bestiary\dragon/young-brass-dragon.md)
...
- "desc": "The dragon uses one of the following breath weapons.\n\n- Fire Breath.\
    ...
    \ area must succeed on a DC 14 Constitution saving throw or fall [unconscious](Misc%20Files/CLI/rules/conditions.md#Unconscious)\
    \ for 5 minutes. This effect ends for a creature if the creature takes damage\
    \ or someone uses an action to wake it.  "
  "name": "Breath Weapons (Recharge 5-6)"
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/dragon/token/young-brass-dragon.webp"
```
^statblock
