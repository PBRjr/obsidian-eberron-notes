...
---
# [Young Red Shadow Dragon](Misc Files\CLI\compendium\bestiary\dragon/young-red-shadow-dragon.md)
...
The dragon's proficiency bonus is doubled for its Dexterity ([Stealth](Misc%20Files/CLI/rules/skills.md#Stealth)) checks.
...
While in dim light or darkness, the dragon can take the [Hide](Misc%20Files/CLI/rules/actions.md#Hide) action as a bonus action.

### Sunlight Sensitivity

While in sunlight, the dragon has disadvantage on attack rolls, as well as on Wisdom ([Perception](Misc%20Files/CLI/rules/skills.md#Perception)) checks that rely on sight.
...
- "desc": "The dragon exhales shadowy fire in a 30-foot cone. Each creature in that\
    ...
    \ to 0 hit points by this damage dies, and an undead [shadow](Misc%20Files/CLI/compendium/bestiary/undead/shadow.md)\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/dragon/token/young-red-shadow-dragon.webp"
```
^statblock
