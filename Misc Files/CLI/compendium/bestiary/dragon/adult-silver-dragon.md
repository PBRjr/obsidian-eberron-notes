...
---
# [Adult Silver Dragon](Misc Files\CLI\compendium\bestiary\dragon/adult-silver-dragon.md)
...
- "desc": "The dragon uses one of the following breath weapons.\n\n- Cold Breath.\
    ...
    \ in that area must succeed on a DC 20 Constitution saving throw or be [paralyzed](Misc%20Files/CLI/rules/conditions.md#Paralyzed)\
    \ for 1 minute. A creature can repeat the saving throw at the end of each of its\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/dragon/token/adult-silver-dragon.webp"
```
^statblock
