...
---
# [Brass Dragon Wyrmling](Misc Files\CLI\compendium\bestiary\dragon/brass-dragon-wyrmling.md)
...
- "desc": "The dragon uses one of the following breath weapons.\n\n- Fire Breath.\
    ...
    \ area must succeed on a DC 11 Constitution saving throw or fall [unconscious](Misc%20Files/CLI/rules/conditions.md#Unconscious)\
    \ for 1 minute. This effect ends for a creature if the creature takes damage or\
    \ someone uses an action to wake it.  "
  "name": "Breath Weapons (Recharge 5-6)"
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/dragon/token/brass-dragon-wyrmling.webp"
```
^statblock