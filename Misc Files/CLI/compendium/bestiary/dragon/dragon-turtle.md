...
---
# [Dragon Turtle](Misc Files\CLI\compendium\bestiary\dragon/dragon-turtle.md)
...
- "desc": "Melee Weapon Attack: +13 to hit, reach 15 ft., one target. Hit: 26\
    ...
    \ turtle and knocked [prone](Misc%20Files/CLI/rules/conditions.md#Prone)."
  "name": "Tail"
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/dragon/token/dragon-turtle.webp"
```
^statblock
