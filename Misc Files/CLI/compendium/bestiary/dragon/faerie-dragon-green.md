...
---
# [Faerie Dragon (Green)](Misc Files\CLI\compendium\bestiary\dragon/faerie-dragon-green.md)
...
- "desc": "The dragon's innate spellcasting ability is Charisma (spell save DC 13).\
    ...
    \n1/day each: [color spray](Misc%20Files/CLI/compendium/spells/color-spray-xphb.md),\
    ...
    \ [mirror image](Misc%20Files/CLI/compendium/spells/mirror-image-xphb.md), [suggestion](Misc%20Files/CLI/compendium/spells/suggestion-xphb.md)"
...
- "desc": "As a bonus action, the dragon can magically turn [invisible](Misc%20Files/CLI/rules/conditions.md#Invisible)\
    ...
    \ on a spell). Any equipment the dragon wears or carries is [invisible](Misc%20Files/CLI/rules/conditions.md#Invisible)\
    \ with it."
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/dragon/token/faerie-dragon-green.webp"
```
^statblock
