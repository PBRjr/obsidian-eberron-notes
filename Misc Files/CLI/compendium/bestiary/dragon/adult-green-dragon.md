...
---
# [Adult Green Dragon](Misc Files\CLI\compendium\bestiary\dragon/adult-green-dragon.md)
...
- "desc": "- Grasping roots and vines erupt in a 20-foot radius centered on a point\
    ...
    \ of it. The creature must succeed on a DC 15 Wisdom saving throw or be [charmed](Misc%20Files/CLI/rules/conditions.md#Charmed)\
    \ by the dragon until initiative count 20 on the next round.  "
  "name": ""
- "desc": "At your discretion, a legendary ([adult](Misc%20Files/CLI/compendium/bestiary/dragon/adult-green-dragon.md)\
    \ or [ancient](Misc%20Files/CLI/compendium/bestiary/dragon/ancient-green-dragon.md))\
    ...
    \ within its lair to animate up to three Humanoid corpses, which become [zombies](Misc%20Files/CLI/compendium/bestiary/undead/zombie-xmm.md).\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/dragon/token/adult-green-dragon.webp"
```
^statblock
