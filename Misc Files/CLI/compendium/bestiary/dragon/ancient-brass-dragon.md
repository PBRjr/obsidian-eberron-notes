...
---
# [Ancient Brass Dragon](Misc Files\CLI\compendium\bestiary\dragon/ancient-brass-dragon.md)
...
- "desc": "Each creature of the dragon's choice that is within 120 feet of the dragon\
    \ and aware of it must succeed on a DC 18 Wisdom saving throw or become [frightened](Misc%20Files/CLI/rules/conditions.md#Frightened)\
...
- "desc": "The dragon uses one of the following breath weapons:\n\n- Fire Breath.\
    ...
    \ area must succeed on a DC 21 Constitution saving throw or fall [unconscious](Misc%20Files/CLI/rules/conditions.md#Unconscious)\
...
- "desc": "- A strong wind blows around the dragon. Each creature within 60 feet of\
    ...
    \ away from the dragon and knocked [prone](Misc%20Files/CLI/rules/conditions.md#Prone).\
    ...
    \ [blinded](Misc%20Files/CLI/rules/conditions.md#Blinded) for 1 minute. A creature\
    \ can repeat the saving throw at the end of each of its turns, ending the effect\
    \ on itself on a success.  "
  "name": ""
- "desc": "At your discretion, a legendary ([adult](Misc%20Files/CLI/compendium/bestiary/dragon/adult-brass-dragon.md)\
    \ or [ancient](Misc%20Files/CLI/compendium/bestiary/dragon/ancient-brass-dragon.md))\
    ...
    \ and be knocked [prone](Misc%20Files/CLI/rules/conditions.md#Prone). Gases and\
    ...
    \ in the wind's direction, and the wind can't knock the dragon [prone](Misc%20Files/CLI/rules/conditions.md#Prone).\
...
- "desc": "- Tracks appear in the sand within 6 miles of the dragon's lair. The tracks\
    ...
    \ DC 20 Intelligence ([Investigation](Misc%20Files/CLI/rules/skills.md#Investigation))\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/dragon/token/ancient-brass-dragon.webp"
```
^statblock
