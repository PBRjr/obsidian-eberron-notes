...
aliases: ["Treant"]
---
# [Treant](Misc Files\CLI\compendium\bestiary\plant/treant.md)
*Source: Monster Manual p. 289, Eberron: Rising from the Last War. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
- "desc": "The treant magically animates one or two trees it can see within 60 feet\
    \ of it. These trees have the same statistics as a [treant](Misc%20Files/CLI/compendium/bestiary/plant/treant.md),\
...
- "MM"
- "ERLW"
"image": "Misc%20Files/CLI/compendium/bestiary/plant/token/treant.webp"
```
^statblock
