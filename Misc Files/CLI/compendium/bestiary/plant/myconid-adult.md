...
---
# [Myconid Adult](Misc Files\CLI\compendium\bestiary\plant/myconid-adult.md)
...
- "desc": "The myconid ejects spores at one creature it can see within 5 feet of it.\
    \ The target must succeed on a DC 11 Constitution saving throw or be [stunned](Misc%20Files/CLI/rules/conditions.md#Stunned)\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/plant/token/myconid-adult.webp"
```
^statblock
