...
aliases: ["Gas Spore"]
---
# [Gas Spore](Misc Files\CLI\compendium\bestiary\plant/gas-spore.md)
...
- "desc": "The gas spore explodes when it drops to 0 hit points. Each creature within\
    ...
    \ immune to the [poisoned](Misc%20Files/CLI/rules/conditions.md#Poisoned) condition\
    ...
    \ [poisoned](Misc%20Files/CLI/rules/conditions.md#Poisoned) for the rest of the\
...
- "desc": "The gas spore resembles a beholder. A creature that can see the gas spore\
    \ can discern its true nature with a successful DC 15 Intelligence ([Nature](Misc%20Files/CLI/rules/skills.md#Nature))\
    \ check."
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/plant/token/gas-spore.webp"
```
^statblock
