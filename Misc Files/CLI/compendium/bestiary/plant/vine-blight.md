...
aliases: ["Vine Blight"]
---
# [Vine Blight](Misc Files\CLI\compendium\bestiary\plant/vine-blight.md)
...
- "desc": "Melee Weapon Attack: +4 to hit, reach 10 ft., one target. Hit: 9\
    \ (2d6 + 2) bludgeoning damage, and a Large or smaller target is [grappled](Misc%20Files/CLI/rules/conditions.md#Grappled)\
...
- "desc": "Grasping roots and vines sprout in a 15-foot radius centered on the blight,\
    ...
    \ or become [restrained](Misc%20Files/CLI/rules/conditions.md#Restrained). A creature\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/plant/token/vine-blight.webp"
```
^statblock
