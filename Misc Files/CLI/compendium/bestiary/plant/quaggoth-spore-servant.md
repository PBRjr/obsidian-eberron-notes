...
---
# [Quaggoth Spore Servant](Misc Files\CLI\compendium\bestiary\plant/quaggoth-spore-servant.md)
...
The servant has [blindsight](Misc%20Files/CLI/rules/senses.md#Blindsight) with a radius of 30 feet, and it is blind beyond this radius.

## Condition Immunities

The servant can't be [blinded](Misc%20Files/CLI/rules/conditions.md#Blinded), [charmed](Misc%20Files/CLI/rules/conditions.md#Charmed), [frightened](Misc%20Files/CLI/rules/conditions.md#Frightened), or [paralyzed](Misc%20Files/CLI/rules/conditions.md#Paralyzed).
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/plant/token/quaggoth-spore-servant.webp"
```
^statblock
