...
---
# [Shambling Mound](Misc Files\CLI\compendium\bestiary\plant/shambling-mound.md)
...
- "desc": "The shambling mound makes two slam attacks. If both attacks hit a Medium\
    \ or smaller target, the target is [grappled](Misc%20Files/CLI/rules/conditions.md#Grappled)\
    \ (escape DC 14), and the shambling mound uses its Engulf on it."
  "name": "Multiattack"
- "desc": "Melee Weapon Attack: +7 to hit, reach 5 ft., one target. Hit: 13\
    \ (2d8 + 4) bludgeoning damage."
  "name": "Slam"
- "desc": "The shambling mound engulfs a Medium or smaller creature [grappled](Misc%20Files/CLI/rules/conditions.md#Grappled)\
    \ by it. The engulfed target is [blinded](Misc%20Files/CLI/rules/conditions.md#Blinded),\
    \ [restrained](Misc%20Files/CLI/rules/conditions.md#Restrained), and unable to\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/plant/token/shambling-mound.webp"
```
^statblock
