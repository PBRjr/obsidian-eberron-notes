...
aliases: ["Hydra"]
---
# [Hydra](Misc Files\CLI\compendium\bestiary\monstrosity/hydra.md)
...
- "desc": "The hydra has five heads. While it has more than one head, the hydra has\
    \ advantage on saving throws against being [blinded](Misc%20Files/CLI/rules/conditions.md#Blinded),\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/monstrosity/token/hydra.webp"
```
^statblock
