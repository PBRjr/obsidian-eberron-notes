...
---
# [Doppelganger](Misc Files\CLI\compendium\bestiary\monstrosity/doppelganger.md)
...
- "desc": "In the first round of a combat, the doppelganger has advantage on attack\
    \ rolls against any creature it [surprised](Misc%20Files/CLI/rules/conditions.md#Surprised)."
  "name": "Ambusher"
...
- "desc": "The doppelganger magically reads the surface thoughts of one creature within\
    ...
    \ as long as the doppelganger's [concentration](Misc%20Files/CLI/rules/conditions.md#Concentration)\
    \ isn't broken (as if [concentrating](Misc%20Files/CLI/rules/conditions.md#Concentration)\
    \ on a spell). While reading the target's mind, the doppelganger has advantage\
    \ on Wisdom ([Insight](Misc%20Files/CLI/rules/skills.md#Insight)) and Charisma\
    \ ([Deception](Misc%20Files/CLI/rules/skills.md#Deception), [Intimidation](Misc%20Files/CLI/rules/skills.md#Intimidation),\
    \ and [Persuasion](Misc%20Files/CLI/rules/skills.md#Persuasion)) checks against\
    \ the target."
  "name": "Read Thoughts"
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/monstrosity/token/doppelganger.webp"
```
^statblock
