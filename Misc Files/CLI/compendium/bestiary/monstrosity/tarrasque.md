...
aliases: ["Tarrasque"]
---
# [Tarrasque](Misc Files\CLI\compendium\bestiary\monstrosity/tarrasque.md)
...
- "desc": "Any time the tarrasque is targeted by a [magic missile](Misc%20Files/CLI/compendium/spells/magic-missile-xphb.md)\
...
- "desc": "Melee Weapon Attack: +19 to hit, reach 10 ft., one target. Hit: 36\
    \ (4d12 + 10) piercing damage. If the target is a creature, it is [grappled](Misc%20Files/CLI/rules/conditions.md#Grappled)\
...
- "desc": "Melee Weapon Attack: +19 to hit, reach 20 ft., one target. Hit: 24\
    ...
    \ on a DC 20 Strength saving throw or be knocked [prone](Misc%20Files/CLI/rules/conditions.md#Prone)."
  "name": "Tail"
- "desc": "Each creature of the tarrasque's choice within 120 feet of it and aware\
    \ of it must succeed on a DC 17 Wisdom saving throw or become [frightened](Misc%20Files/CLI/rules/conditions.md#Frightened)\
...
- "desc": "The tarrasque makes one bite attack against a Large or smaller creature\
    ...
    \ [blinded](Misc%20Files/CLI/rules/conditions.md#Blinded) and [restrained](Misc%20Files/CLI/rules/conditions.md#Restrained),\
    ...
    \ the end of that turn or regurgitate all swallowed creatures, which fall [prone](Misc%20Files/CLI/rules/conditions.md#Prone)\
    \ in a space within 10 feet of the tarrasque. If the tarrasque dies, a swallowed\
    \ creature is no longer [restrained](Misc%20Files/CLI/rules/conditions.md#Restrained)\
    \ by it and can escape from the corpse by using 30 feet of movement, exiting [prone](Misc%20Files/CLI/rules/conditions.md#Prone)."
  "name": "Swallow"
"legendary_actions":
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/monstrosity/token/tarrasque.webp"
```
^statblock
