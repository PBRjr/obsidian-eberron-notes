...
---
# [Abominable Yeti](Misc Files\CLI\compendium\bestiary\monstrosity/abominable-yeti.md)
...
- "desc": "If the yeti takes fire damage, it has disadvantage on attack rolls and\
  ...
  "name": "Fear of Fire"
- "desc": "The yeti has advantage on Wisdom ([Perception](Misc%20Files/CLI/rules/skills.md#Perception))\
    \ checks that rely on smell."
  "name": "Keen Smell"
- "desc": "The yeti has advantage on Dexterity ([Stealth](Misc%20Files/CLI/rules/skills.md#Stealth))\
...
- "desc": "The yeti targets one creature it can see within 30 feet of it. If the target\
    ...
    \ against this magic or take 21 (6d6) cold damage and then be [paralyzed](Misc%20Files/CLI/rules/conditions.md#Paralyzed)\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/monstrosity/token/abominable-yeti.webp"
```
^statblock
