...
---
# [Phase Spider](Misc Files\CLI\compendium\bestiary\monstrosity/phase-spider.md)
...
- "desc": "Melee Weapon Attack: +4 to hit, reach 5 ft., one creature. Hit: 7\
    ...
    \ points, the target is stable but [poisoned](Misc%20Files/CLI/rules/conditions.md#Poisoned)\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/monstrosity/token/phase-spider.webp"
```
^statblock
