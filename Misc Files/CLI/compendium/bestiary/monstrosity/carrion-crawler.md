...
---
# [Carrion Crawler](Misc Files\CLI\compendium\bestiary\monstrosity/carrion-crawler.md)
...
"cr": "2"
"traits":
- "desc": "The carrion crawler has advantage on Wisdom ([Perception](Misc%20Files/CLI/rules/skills.md#Perception))\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/monstrosity/token/carrion-crawler.webp"
```
^statblock
