...
aliases: ["Grick Alpha"]
---
# [Grick Alpha](Misc Files\CLI\compendium\bestiary\monstrosity/grick-alpha.md)
...
"cr": "7"
"traits":
- "desc": "The grick has advantage on Dexterity ([Stealth](Misc%20Files/CLI/rules/skills.md#Stealth))\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/monstrosity/token/grick-alpha.webp"
```
^statblock
