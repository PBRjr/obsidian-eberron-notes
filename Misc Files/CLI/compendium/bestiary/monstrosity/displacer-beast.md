...
---
# [Displacer Beast](Misc Files\CLI\compendium\bestiary\monstrosity/displacer-beast.md)
...
- "desc": "The displacer beast projects a magical illusion that makes it appear to\
    ...
    \ [incapacitated](Misc%20Files/CLI/rules/conditions.md#Incapacitated) or has a\
    \ speed of 0."
  "name": "Displacement"
"actions":
...
- "MM"
- "ERLW"
"image": "Misc%20Files/CLI/compendium/bestiary/monstrosity/token/displacer-beast.webp"
```
^statblock
