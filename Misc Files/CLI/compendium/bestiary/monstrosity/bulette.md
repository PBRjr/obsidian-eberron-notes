...
aliases: ["Bulette"]
---
# [Bulette](Misc Files\CLI\compendium\bestiary\monstrosity/bulette.md)
...
- "desc": "If the bulette jumps at least 15 feet as part of its movement, it can then\
    ...
    \ saving throw (target's choice) or be knocked [prone](Misc%20Files/CLI/rules/conditions.md#Prone)\
    ...
    \ [prone](Misc%20Files/CLI/rules/conditions.md#Prone), and is pushed 5 feet out\
    \ of the bulette's space into an unoccupied space of the creature's choice. If\
    \ no unoccupied space is within range, the creature instead falls [prone](Misc%20Files/CLI/rules/conditions.md#Prone)\
    \ in the bulette's space."
  "name": "Deadly Leap"
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/monstrosity/token/bulette.webp"
```
^statblock
