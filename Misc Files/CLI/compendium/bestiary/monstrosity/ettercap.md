...
aliases: ["Ettercap"]
---
# [Ettercap](Misc Files\CLI\compendium\bestiary\monstrosity/ettercap.md)
...
- "desc": "Melee Weapon Attack: +4 to hit, reach 5 ft., one creature. Hit: 6\
    ...
    \ on a DC 11 Constitution saving throw or be [poisoned](Misc%20Files/CLI/rules/conditions.md#Poisoned)\
...
- "desc": "Ranged Weapon Attack: +4 to hit, range 30/60 ft., one Large or smaller\
    \ creature. Hit: The creature is [restrained](Misc%20Files/CLI/rules/conditions.md#Restrained)\
    \ by webbing. As an action, the [restrained](Misc%20Files/CLI/rules/conditions.md#Restrained)\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/monstrosity/token/ettercap.webp"
```
^statblock
