...
aliases: ["Roc"]
---
# [Roc](Misc Files\CLI\compendium\bestiary\monstrosity/roc.md)
...
"cr": "11"
"traits":
- "desc": "The roc has advantage on Wisdom ([Perception](Misc%20Files/CLI/rules/skills.md#Perception))\
...
- "desc": "Melee Weapon Attack: +13 to hit, reach 5 ft., one target. Hit: 23\
    \ (4d6 + 9) slashing damage, and the target is [grappled](Misc%20Files/CLI/rules/conditions.md#Grappled)\
    \ (escape DC 19). Until this grapple ends, the target is [restrained](Misc%20Files/CLI/rules/conditions.md#Restrained),\
    \ and the roc can't use its talons on another target."
  "name": "Talons"
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/monstrosity/token/roc.webp"
```
^statblock
