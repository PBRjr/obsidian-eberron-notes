...
aliases: ["Remorhaz"]
---
# [Remorhaz](Misc Files\CLI\compendium\bestiary\monstrosity/remorhaz.md)
...
- "desc": "Melee Weapon Attack: +11 to hit, reach 10 ft., one target. Hit: 40\
    ...
    \ creature, it is [grappled](Misc%20Files/CLI/rules/conditions.md#Grappled) (escape\
    \ DC 17). Until this grapple ends, the target is [restrained](Misc%20Files/CLI/rules/conditions.md#Restrained),\
...
- "desc": "The remorhaz makes one bite attack against a Medium or smaller creature\
    ...
    \ is swallowed, and the grapple ends. While swallowed, the creature is [blinded](Misc%20Files/CLI/rules/conditions.md#Blinded)\
    ...
    \ that turn or regurgitate all swallowed creatures, which fall [prone](Misc%20Files/CLI/rules/conditions.md#Prone)\
    ...
    \ by it and can escape from the corpse using 15 feet of movement, exiting [prone](Misc%20Files/CLI/rules/conditions.md#Prone)."
  "name": "Swallow"
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/monstrosity/token/remorhaz.webp"
```
^statblock
