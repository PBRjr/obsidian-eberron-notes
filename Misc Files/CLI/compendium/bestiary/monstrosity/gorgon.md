...
aliases: ["Gorgon"]
---
# [Gorgon](Misc Files\CLI\compendium\bestiary\monstrosity/gorgon.md)
...
- "desc": "If the gorgon moves at least 20 feet straight toward a creature and then\
    ...
    \ 16 Strength saving throw or be knocked [prone](Misc%20Files/CLI/rules/conditions.md#Prone).\
    \ If the target is [prone](Misc%20Files/CLI/rules/conditions.md#Prone), the gorgon\
...
- "desc": "The gorgon exhales petrifying gas in a 30-foot cone. Each creature in that\
    ...
    \ target begins to turn to stone and is [restrained](Misc%20Files/CLI/rules/conditions.md#Restrained).\
    \ The [restrained](Misc%20Files/CLI/rules/conditions.md#Restrained) target must\
    \ repeat the saving throw at the end of its next turn. On a success, the effect\
    \ ends on the target. On a failure, the target is [petrified](Misc%20Files/CLI/rules/conditions.md#Petrified)\
    \ until freed by the  [greater restoration](Misc%20Files/CLI/compendium/spells/greater-restoration-xphb.md)\
    \ spell or other magic."
  "name": "Petrifying Breath (Recharge 5-6)"
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/monstrosity/token/gorgon.webp"
```
^statblock
