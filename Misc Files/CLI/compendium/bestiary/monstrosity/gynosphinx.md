...
aliases: ["Gynosphinx"]
---
# [Gynosphinx](Misc Files\CLI\compendium\bestiary\monstrosity/gynosphinx.md)
...
- "desc": "The sphinx is a 9th-level spellcaster. Its spellcasting ability is Intelligence\
    ...
    \n2nd level (3 slots): [darkness](Misc%20Files/CLI/compendium/spells/darkness-xphb.md),\
    \ [locate object](Misc%20Files/CLI/compendium/spells/locate-object-xphb.md), [suggestion](Misc%20Files/CLI/compendium/spells/suggestion-xphb.md)\n\
    \n3rd level (3 slots): [dispel magic](Misc%20Files/CLI/compendium/spells/dispel-magic-xphb.md),\
    \ [remove curse](Misc%20Files/CLI/compendium/spells/remove-curse-xphb.md), [tongues](Misc%20Files/CLI/compendium/spells/tongues-xphb.md)\n\
    ...
    \n5th level (1 slots): [legend lore](Misc%20Files/CLI/compendium/spells/legend-lore-xphb.md)"
  "name": "Spellcasting"
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/monstrosity/token/gynosphinx.webp"
```
^statblock
