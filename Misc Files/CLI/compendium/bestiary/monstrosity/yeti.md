...
aliases: ["Yeti"]
---
# [Yeti](Misc Files\CLI\compendium\bestiary\monstrosity/yeti.md)
...
- "desc": "The yeti targets one creature it can see within 30 feet of it. If the target\
    ...
    \ against this magic or take 10 (3d6) cold damage and then be [paralyzed](Misc%20Files/CLI/rules/conditions.md#Paralyzed)\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/monstrosity/token/yeti.webp"
```
^statblock
