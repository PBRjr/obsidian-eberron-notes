...
aliases: ["Death Dog"]
---
# [Death Dog](Misc Files\CLI\compendium\bestiary\monstrosity/death-dog.md)
...
- "desc": "The dog has advantage on Wisdom ([Perception](Misc%20Files/CLI/rules/skills.md#Perception))\
    \ checks and on saving throws against being [blinded](Misc%20Files/CLI/rules/conditions.md#Blinded),\
    ...
    \ or knocked [unconscious](Misc%20Files/CLI/rules/conditions.md#Unconscious)."
  "name": "Two-Headed"
"actions":
...
- "desc": "Melee Weapon Attack: +4 to hit, reach 5 ft., one target. Hit: 5 (1d6\
    ...
    \ 12 Constitution saving throw against disease or become [poisoned](Misc%20Files/CLI/rules/conditions.md#Poisoned)\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/monstrosity/token/death-dog.webp"
```
^statblock
