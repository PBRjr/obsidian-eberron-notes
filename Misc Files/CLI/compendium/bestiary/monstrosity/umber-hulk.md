...
aliases: ["Umber Hulk"]
---
# [Umber Hulk](Misc Files\CLI\compendium\bestiary\monstrosity/umber-hulk.md)
...
- "desc": "When a creature starts its turn within 30 feet of the umber hulk and is\
    ...
    \ make a DC 15 Charisma saving throw, unless the umber hulk is [incapacitated](Misc%20Files/CLI/rules/conditions.md#Incapacitated).\n\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/monstrosity/token/umber-hulk.webp"
```
^statblock
