...
aliases: ["Minotaur"]
---
# [Minotaur](Misc Files\CLI\compendium\bestiary\monstrosity/minotaur.md)
*Source: Monster Manual p. 223, Eberron: Rising from the Last War. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*  
...
- "desc": "If the minotaur moves at least 10 feet straight toward a target and then\
    ...
    \ saving throw or be pushed up to 10 feet away and knocked [prone](Misc%20Files/CLI/rules/conditions.md#Prone)."
  "name": "Charge"
...
- "MM"
- "ERLW"
"image": "Misc%20Files/CLI/compendium/bestiary/monstrosity/token/minotaur.webp"
```
^statblock
