...
aliases: ["Peryton"]
---
# [Peryton](Misc Files\CLI\compendium\bestiary\monstrosity/peryton.md)
...
- "desc": "The peryton doesn't provoke an opportunity attack when it flies out of\
    \ an enemy's reach."
  "name": "Flyby"
- "desc": "The peryton has advantage on Wisdom ([Perception](Misc%20Files/CLI/rules/skills.md#Perception))\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/monstrosity/token/peryton.webp"
```
^statblock
