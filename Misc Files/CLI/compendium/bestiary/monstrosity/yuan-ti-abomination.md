...
---
# [Yuan-ti Abomination](Misc Files\CLI\compendium\bestiary\monstrosity/yuan-ti-abomination.md)
...
- "desc": "The yuan-ti's innate spellcasting ability is Charisma (spell save DC 15).\
    ...
    \nAt will: [animal friendship](Misc%20Files/CLI/compendium/spells/animal-friendship-xphb.md)\
    \ (snakes only)\n\n1/day: [fear](Misc%20Files/CLI/compendium/spells/fear-xphb.md)\n\
    \n3/day: [suggestion](Misc%20Files/CLI/compendium/spells/suggestion-xphb.md)"
...
- "desc": "Melee Weapon Attack: +7 to hit, reach 10 ft., one target. Hit: 11\
    \ (2d6 + 4) bludgeoning damage, and the target is [grappled](Misc%20Files/CLI/rules/conditions.md#Grappled)\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/monstrosity/token/yuan-ti-abomination.webp"
```
^statblock
