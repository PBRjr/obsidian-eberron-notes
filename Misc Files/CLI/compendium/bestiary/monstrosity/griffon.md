...
aliases: ["Griffon"]
---
# [Griffon](Misc Files\CLI\compendium\bestiary\monstrosity/griffon.md)
*Source: Monster Manual p. 174, Eberron: Rising from the Last War. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*  
...
"cr": "2"
"traits":
- "desc": "The griffon has advantage on Wisdom ([Perception](Misc%20Files/CLI/rules/skills.md#Perception))\
...
- "MM"
- "ERLW"
"image": "Misc%20Files/CLI/compendium/bestiary/monstrosity/token/griffon.webp"
```
^statblock
