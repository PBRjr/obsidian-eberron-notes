...
aliases: ["Mud Mephit"]
---
# [Mud Mephit](Misc Files\CLI\compendium\bestiary\elemental/mud-mephit.md)
...
- "desc": "When the mephit dies, it explodes in a burst of sticky mud. Each Medium\
    ...
    \ throw or be [restrained](Misc%20Files/CLI/rules/conditions.md#Restrained) until\
...
- "desc": "The mephit belches viscid mud onto one creature within 5 feet of it. If\
    ...
    \ throw or be [restrained](Misc%20Files/CLI/rules/conditions.md#Restrained) for\
    \ 1 minute. A creature can repeat the saving throw at the end of each of its turns,\
    \ ending the effect on itself on a success."
  "name": "Mud Breath (Recharge 6)"
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/elemental/token/mud-mephit.webp"
```
^statblock
