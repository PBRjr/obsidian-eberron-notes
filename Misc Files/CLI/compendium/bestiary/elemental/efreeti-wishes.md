...
---
# [Efreeti (Wishes)](Misc Files\CLI\compendium\bestiary\elemental/efreeti-wishes.md)
...
- "desc": "The efreeti's innate spellcasting ability is Charisma (spell save DC 15,\
    ...
    \ ([fire elemental](Misc%20Files/CLI/compendium/bestiary/elemental/fire-elemental.md)\
    \ only), [gaseous form](Misc%20Files/CLI/compendium/spells/gaseous-form-xphb.md),\
    \ [invisibility](Misc%20Files/CLI/compendium/spells/invisibility-xphb.md), [major\
    \ image](Misc%20Files/CLI/compendium/spells/major-image-xphb.md), [plane shift](Misc%20Files/CLI/compendium/spells/plane-shift-xphb.md),\
    \ [wall of fire](Misc%20Files/CLI/compendium/spells/wall-of-fire-xphb.md)\n\n\
    3/day each: [enlarge/reduce](Misc%20Files/CLI/compendium/spells/enlarge-reduce-xphb.md),\
...
- "desc": "The genie power to grant wishes is legendary among mortals. Only the most\
    ...
    \ the genie states a desired effect to it. The genie can then cast the [wish](Misc%20Files/CLI/compendium/spells/wish-xphb.md)\
