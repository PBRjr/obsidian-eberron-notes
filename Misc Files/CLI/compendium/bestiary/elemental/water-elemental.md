...
---
# [Water Elemental](Misc Files\CLI\compendium\bestiary\elemental/water-elemental.md)
...
- "desc": "Each creature in the elemental's space must make a DC 15 Strength saving\
    ...
    \ is Large or smaller, it is also [grappled](Misc%20Files/CLI/rules/conditions.md#Grappled)\
    ...
    \ the start of each of the elemental's turns, each target [grappled](Misc%20Files/CLI/rules/conditions.md#Grappled)\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/elemental/token/water-elemental.webp"
```
^statblock
