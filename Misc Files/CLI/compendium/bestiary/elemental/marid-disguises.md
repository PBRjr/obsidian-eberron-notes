...
---
# [Marid (Disguises)](Misc Files\CLI\compendium\bestiary\elemental/marid-disguises.md)
...
- "desc": "The marid's innate spellcasting ability is Charisma (spell save DC 16,\
    ...
    \ drink](Misc%20Files/CLI/compendium/spells/purify-food-and-drink-xphb.md), [disguise\
    \ self](Misc%20Files/CLI/compendium/spells/disguise-self-xphb.md) (often with\
    \ a longer duration than is normal for that spell; see Disguises)\n\n1/day each:\
    ...
    \ walk](Misc%20Files/CLI/compendium/spells/water-walk-xphb.md), [true polymorph](Misc%20Files/CLI/compendium/spells/true-polymorph-xphb.md)\
...
- "desc": "Some genies can veil themselves in illusion to pass as other similarly\
    \ shaped creatures. Such genies can innately cast the [disguise self](Misc%20Files/CLI/compendium/spells/disguise-self-xphb.md)\
    \ spell at will, often with a longer duration than is normal for that spell. Mightier\
    \ genies can cast the [true polymorph](Misc%20Files/CLI/compendium/spells/true-polymorph-xphb.md)\
