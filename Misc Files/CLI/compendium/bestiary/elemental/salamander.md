...
aliases: ["Salamander"]
---
# [Salamander](Misc Files\CLI\compendium\bestiary\elemental/salamander.md)
...
- "desc": "Melee Weapon Attack: +7 to hit, reach 10 ft., one target. Hit: 11\
    ...
    \ [grappled](Misc%20Files/CLI/rules/conditions.md#Grappled) (escape DC 14). Until\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/elemental/token/salamander.webp"
```
^statblock
