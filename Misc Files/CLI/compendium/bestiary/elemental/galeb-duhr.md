...
aliases: ["Galeb Duhr"]
---
# [Galeb Duhr](Misc Files\CLI\compendium\bestiary\elemental/galeb-duhr.md)
...
- "desc": "The galeb duhr magically animates up to two boulders it can see within\
    ...
    \ has Intelligence 1 and Charisma 1, it can't be [charmed](Misc%20Files/CLI/rules/conditions.md#Charmed)\
    \ or [frightened](Misc%20Files/CLI/rules/conditions.md#Frightened), and it lacks\
    \ this action option. A boulder remains animated as long as the galeb duhr maintains\
    \ [concentration](Misc%20Files/CLI/rules/conditions.md#Concentration), up to 1\
    \ minute (as if [concentrating](Misc%20Files/CLI/rules/conditions.md#Concentration)\
    \ on a spell)."
  "name": "Animate Boulders (1/Day)"
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/elemental/token/galeb-duhr.webp"
```
^statblock
