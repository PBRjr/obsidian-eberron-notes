...
---
# [Death Tyrant](Misc Files\CLI\compendium\bestiary\undead/death-tyrant.md)
...
"cr": "14"
"traits":
- "desc": "The death tyrant's central eye emits an [invisible](Misc%20Files/CLI/rules/conditions.md#Invisible),\
    ...
    \ becomes a [zombie](Misc%20Files/CLI/compendium/bestiary/undead/zombie-xmm.md)\
...
- "desc": "The death tyrant shoots three of the following magical eye rays at random\
    ...
    \ Wisdom saving throw or be [charmed](Misc%20Files/CLI/rules/conditions.md#Charmed)\
    ...
    \ saving throw or be [paralyzed](Misc%20Files/CLI/rules/conditions.md#Paralyzed)\
    \ for 1 minute. The target can repeat the saving throw at the end of each of its\
    \ turns, ending the effect on itself on a success.  \n- 3. Fear Ray. The targeted\
    \ creature must succeed on a DC 17 Wisdom saving throw or be [frightened](Misc%20Files/CLI/rules/conditions.md#Frightened)\
    \ for 1 minute. The target can repeat the saving throw at the end of each of its\
    \ turns, ending the effect on itself on a success.  \n- 4. Slowing Ray. The\
    ...
    \ in any direction. It is [restrained](Misc%20Files/CLI/rules/conditions.md#Restrained)\
    \ by the ray's telekinetic grip until the start of the death tyrant's next turn\
    \ or until the death tyrant is [incapacitated](Misc%20Files/CLI/rules/conditions.md#Incapacitated).\
    ...
    \ [unconscious](Misc%20Files/CLI/rules/conditions.md#Unconscious) for 1 minute.\
    ...
    \ failed save, the creature begins to turn to stone and is [restrained](Misc%20Files/CLI/rules/conditions.md#Restrained).\
...
- "desc": "- An area that is a 50-foot cube within 120 feet of the tyrant is filled\
    ...
    \ Escaping requires a successful DC 17 Strength ([Athletics](Misc%20Files/CLI/rules/skills.md#Athletics))\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/undead/token/death-tyrant.webp"
```
^statblock
