...
aliases: ["Mummy Lord"]
---
# [Mummy Lord](Misc Files\CLI\compendium\bestiary\undead/mummy-lord.md)
...
- "desc": "The mummy lord is a 10th-level spellcaster. Its spellcasting ability is\
    ...
    \ [guiding bolt](Misc%20Files/CLI/compendium/spells/guiding-bolt-xphb.md), [shield\
    ...
    \ [silence](Misc%20Files/CLI/compendium/spells/silence-xphb.md), [spiritual weapon](Misc%20Files/CLI/compendium/spells/spiritual-weapon-xphb.md)\n\
    ...
    \n5th level (2 slots): [contagion](Misc%20Files/CLI/compendium/spells/contagion-xphb.md),\
    \ [insect plague](Misc%20Files/CLI/compendium/spells/insect-plague-xphb.md)\n\n\
    6th level (1 slots): [harm](Misc%20Files/CLI/compendium/spells/harm-xphb.md)"
  "name": "Spellcasting"
...
- "desc": "The mummy lord targets one creature it can see within 60 feet of it. If\
    ...
    \ throw against this magic or become [frightened](Misc%20Files/CLI/rules/conditions.md#Frightened)\
...
- "desc": "The mummy lord utters a blasphemous word. Each non-undead creature within\
    ...
    \ a DC 16 Constitution saving throw or be [stunned](Misc%20Files/CLI/rules/conditions.md#Stunned)\
...
- "desc": "The mummy lord magically transforms into a whirlwind of sand, moves up\
    ...
    \ lord is immune to all damage, and it can't be [grappled](Misc%20Files/CLI/rules/conditions.md#Grappled),\
    \ [petrified](Misc%20Files/CLI/rules/conditions.md#Petrified), knocked [prone](Misc%20Files/CLI/rules/conditions.md#Prone),\
    \ [restrained](Misc%20Files/CLI/rules/conditions.md#Restrained), or [stunned](Misc%20Files/CLI/rules/conditions.md#Stunned).\
...
- "desc": "- Food instantly molders and water instantly evaporates when brought into\
    ...
    \ [divination](Misc%20Files/CLI/compendium/spells/divination-xphb.md) spell already\
    \ has a chance to fail or become unreliable when cast multiple times, that chance\
    \ increases by 25 percent.  \n- A creature that takes treasure from the lair is\
    \ cursed until the treasure is returned. The cursed target has disadvantage on\
    \ all saving throws. The curse lasts until removed by a [remove curse](Misc%20Files/CLI/compendium/spells/remove-curse-xphb.md)\
    \ spell or other magic.  "
  "name": ""
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/undead/token/mummy-lord.webp"
```
^statblock
