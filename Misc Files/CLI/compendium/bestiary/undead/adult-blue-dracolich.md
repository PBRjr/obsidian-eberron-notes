...
---
# [Adult Blue Dracolich](Misc Files\CLI\compendium\bestiary\undead/adult-blue-dracolich.md)
...
The dracolich can't be [charmed](Misc%20Files/CLI/rules/conditions.md#Charmed), [frightened](Misc%20Files/CLI/rules/conditions.md#Frightened), [paralyzed](Misc%20Files/CLI/rules/conditions.md#Paralyzed), or [poisoned](Misc%20Files/CLI/rules/conditions.md#Poisoned). It also doesn't suffer from [exhaustion](Misc%20Files/CLI/rules/conditions.md#Exhaustion).
...
- "desc": "Each creature of the dracolich's choice that is within 120 feet of the\
    ...
    \ [frightened](Misc%20Files/CLI/rules/conditions.md#Frightened) for 1 minute.\
...
"legendary_actions":
- "desc": "The dracolich makes a Wisdom ([Perception](Misc%20Files/CLI/rules/skills.md#Perception))\
    \ check."
  "name": "Detect"
...
- "desc": "The dracolich beats its tattered wings. Each creature within 10 feet of\
    ...
    \ + 7) bludgeoning damage and be knocked [prone](Misc%20Files/CLI/rules/conditions.md#Prone).\
...
- "desc": "- Part of the ceiling collapses above one creature that the dragon can\
    ...
    \ and buried. The buried target is [restrained](Misc%20Files/CLI/rules/conditions.md#Restrained)\
    ...
    \ cloud must succeed on a DC 15 Constitution saving throw or be [blinded](Misc%20Files/CLI/rules/conditions.md#Blinded)\
  ...
  "name": ""
- "desc": "At your discretion, a legendary ([adult](Misc%20Files/CLI/compendium/bestiary/dragon/adult-blue-dragon.md)\
    \ or [ancient](Misc%20Files/CLI/compendium/bestiary/dragon/ancient-blue-dragon.md))\
    ...
    \ [prone](Misc%20Files/CLI/rules/conditions.md#Prone). On a successful save, a\
...
- "desc": "- Thunderstorms rage within 6 miles of the lair.  \n- Dust devils scour\
    ...
    \ Wisdom ([Perception](Misc%20Files/CLI/rules/skills.md#Perception)) check. Otherwise,\
...
- "desc": "Any of these effects might appear in the area around a blue dragon's lair,\
    ...
    \ attempt a DC 15 Intelligence ([Investigation](Misc%20Files/CLI/rules/skills.md#Investigation))\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/undead/token/adult-blue-dracolich.webp"
```
^statblock
