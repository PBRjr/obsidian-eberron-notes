...
aliases: ["Wraith"]
---
# [Wraith](Misc Files\CLI\compendium\bestiary\undead/wraith.md)
...
- "desc": "The wraith targets a humanoid within 10 feet of it that has been dead for\
    \ no longer than 1 minute and died violently. The target's spirit rises as a [specter](Misc%20Files/CLI/compendium/bestiary/undead/specter.md)\
    \ in the space of its corpse or in the nearest unoccupied space. The [specter](Misc%20Files/CLI/compendium/bestiary/undead/specter.md)\
    \ is under the wraith's control. The wraith can have no more than seven specters\
    \ under its control at one time."
  "name": "Create Specter"
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/undead/token/wraith.webp"
```
^statblock
