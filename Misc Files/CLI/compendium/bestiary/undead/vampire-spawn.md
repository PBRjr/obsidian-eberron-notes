...
---
# [Vampire Spawn](Misc Files\CLI\compendium\bestiary\undead/vampire-spawn.md)
...
- "desc": "The vampire has the following flaws:\n\nForbiddance. The vampire can't\
    ...
    \ weapon made of wood is driven into its heart while it is [incapacitated](Misc%20Files/CLI/rules/conditions.md#Incapacitated)\
...
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one willing creature,\
    ...
    \ or [restrained](Misc%20Files/CLI/rules/conditions.md#Restrained). Hit: 6 (1d6\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/undead/token/vampire-spawn.webp"
```
^statblock
