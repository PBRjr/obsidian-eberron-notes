...
---
# [Vampire Spellcaster](Misc Files\CLI\compendium\bestiary\undead/vampire-spellcaster.md)
...
> 
> The game statistics of a player character transformed into a vampire spawn and then a vampire don't change, except that the character's Strength, Dexterity, and Constitution scores become 18 if they aren't higher. In addition, the character gains the vampire's damage resistances, [darkvision](Misc%20Files/CLI/rules/senses.md#Darkvision), traits, and actions. Attack and damage rolls for the vampire's attacks are based on Strength.
> 
> The save DC for Charm is 8 + the vampire's proficiency bonus + the vampire's Charisma modifier. The character's alignment becomes lawful evil, and the DM might take control of the character until the vampirism is reversed with a [wish](Misc%20Files/CLI/compendium/spells/wish-xphb.md) spell or the character is killed and brought back to life.
...
- "desc": "The vampire is a 9th-level spellcaster. Its spellcasting ability is Intelligence\
    ...
    1st level (4 slots): [comprehend languages](Misc%20Files/CLI/compendium/spells/comprehend-languages-xphb.md),\
    \ [fog cloud](Misc%20Files/CLI/compendium/spells/fog-cloud-xphb.md), [sleep](Misc%20Files/CLI/compendium/spells/sleep-xphb.md)\n\
    \n2nd level (3 slots): [detect thoughts](Misc%20Files/CLI/compendium/spells/detect-thoughts-xphb.md),\
    \ [gust of wind](Misc%20Files/CLI/compendium/spells/gust-of-wind-xphb.md), [mirror\
    ...
    \ [bestow curse](Misc%20Files/CLI/compendium/spells/bestow-curse-xphb.md), [nondetection](Misc%20Files/CLI/compendium/spells/nondetection-xphb.md)\n\
    ...
    \n5th level (1 slots): [dominate person](Misc%20Files/CLI/compendium/spells/dominate-person-xphb.md)"
  "name": "Spellcasting"
...
- "desc": "When it drops to 0 hit points outside its resting place, the vampire transforms\
    \ into a cloud of mist (as in the Shapechanger trait) instead of falling [unconscious](Misc%20Files/CLI/rules/conditions.md#Unconscious),\
    ...
    \ then [paralyzed](Misc%20Files/CLI/rules/conditions.md#Paralyzed) until it regains\
...
- "desc": "The vampire has the following flaws:\n\nForbiddance. The vampire can't\
    ...
    \ into the vampire's heart while the vampire is [incapacitated](Misc%20Files/CLI/rules/conditions.md#Incapacitated)\
    \ in its resting place, the vampire is [paralyzed](Misc%20Files/CLI/rules/conditions.md#Paralyzed)\
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one willing creature,\
    \ or a creature that is [grappled](Misc%20Files/CLI/rules/conditions.md#Grappled)\
    ...
    \ rises the following night as a [vampire spawn](Misc%20Files/CLI/compendium/bestiary/undead/vampire-spawn.md)\
...
- "desc": "The vampire targets one humanoid it can see within 30 feet of it. If the\
    ...
    \ throw against this magic or be [charmed](Misc%20Files/CLI/rules/conditions.md#Charmed)\
    \ by the vampire. The [charmed](Misc%20Files/CLI/rules/conditions.md#Charmed)\
  ...
  "name": "Charm"
- "desc": "The vampire magically calls 2d4 swarms of [bats](Misc%20Files/CLI/compendium/bestiary/beast/swarm-of-bats.md)\
    \ or [rats](Misc%20Files/CLI/compendium/bestiary/beast/swarm-of-rats.md), provided\
    \ that the sun isn't up. While outdoors, the vampire can call 3d6 [wolves](Misc%20Files/CLI/compendium/bestiary/beast/wolf-xmm.md)\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/undead/token/vampire-spellcaster.webp"
```
^statblock
