...
aliases: ["Demilich"]
---
# [Demilich](Misc Files\CLI\compendium\bestiary\undead/demilich.md)
...
- "desc": "The demilich emits a bloodcurdling howl. Each creature within 30 feet of\
    ...
    \ throw or drop to 0 hit points. On a successful save, the creature is [frightened](Misc%20Files/CLI/rules/conditions.md#Frightened)\
...
- "desc": "Each creature with in 30 feet of the demilich must make a DC 15 Constitution\
    ...
    \ with the  [greater restoration](Misc%20Files/CLI/compendium/spells/greater-restoration-xphb.md)\
...
- "desc": "- The tomb trembles violently for a moment. Each creature on the floor\
    \ of the tomb must succeed on a DC 19 Dexterity saving throw or be knocked [prone](Misc%20Files/CLI/rules/conditions.md#Prone).\
    \  \n- The demilich targets one creature it can see within 60 feet of it. An [antimagic\
    \ field](Misc%20Files/CLI/compendium/spells/antimagic-field-xphb.md) fills the\
    \ space of the target, moving with it until initiative count 20 on the next round.\
...
- "desc": "- The first time a non-evil creature enters the tomb's area, the creature\
    ...
    \ or [frightened](Misc%20Files/CLI/rules/conditions.md#Frightened), and against\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/undead/token/demilich.webp"
```
^statblock