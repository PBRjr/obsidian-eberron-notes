...
---
# [Avatar of Death (DMG)](Misc Files\CLI\compendium\bestiary\undead/avatar-of-death-dmg.md)
*Source: Dungeon Master's Guide p. 164. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  

Summoned by the "Skull" card from the [Deck of Many Things](Misc%20Files/CLI/compendium/items/deck-of-many-things-xdmg.md).
...
"source":
- "DMG"
"image": "Misc%20Files/CLI/compendium/bestiary/undead/token/avatar-of-death.webp"
```
^statblock