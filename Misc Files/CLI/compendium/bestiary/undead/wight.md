...
aliases: ["Wight"]
---
# [Wight](Misc Files\CLI\compendium\bestiary\undead/wight.md)
...
- "desc": "Melee Weapon Attack: +4 to hit, reach 5 ft., one creature. Hit: 5\
    ...
    \ by this attack rises 24 hours later as a [zombie](Misc%20Files/CLI/compendium/bestiary/undead/zombie-xmm.md)\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/undead/token/wight.webp"
```
^statblock
