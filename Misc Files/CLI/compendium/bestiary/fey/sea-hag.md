...
aliases: ["Sea Hag"]
---
# [Sea Hag](Misc Files\CLI\compendium\bestiary\fey/sea-hag.md)
...
- "desc": "Any humanoid that starts its turn within 30 feet of the hag and can see\
    ...
    \ the creature is [frightened](Misc%20Files/CLI/rules/conditions.md#Frightened)\
    ...
    \ next 24 hours.\n\nUnless the target is [surprised](Misc%20Files/CLI/rules/conditions.md#Surprised)\
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one target. Hit: 10\
  ...
  "name": "Claws"
- "desc": "The hag targets one [frightened](Misc%20Files/CLI/rules/conditions.md#Frightened)\
...
- "desc": "The hag covers herself and anything she is wearing or carrying with a magical\
    ...
    \ inspect the illusion and succeed on a DC 16 Intelligence ([Investigation](Misc%20Files/CLI/rules/skills.md#Investigation))\
...
- "desc": "- The hag fills up to four 10-foot cubes of water with ink. The inky areas\
    ...
    \ creates a simulacrum of that creature (as if created with the [simulacrum](Misc%20Files/CLI/compendium/spells/simulacrum-xphb.md)\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/fey/token/sea-hag.webp"
```
^statblock
