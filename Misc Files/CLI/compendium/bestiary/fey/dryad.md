...
aliases: ["Dryad"]
---
# [Dryad](Misc Files\CLI\compendium\bestiary\fey/dryad.md)
...
Dryads act as guardians of their woodland demesnes. Shy and reclusive, they watch interlopers from the trees. A dryad struck by the beauty of a stranger might investigate more closely, perhaps even try to lure the individual away to be [charmed](Misc%20Files/CLI/rules/conditions.md#Charmed).
...
- "desc": "The dryad's innate spellcasting ability is Charisma (spell save DC 14).\
    ...
    \n1/day each: [barkskin](Misc%20Files/CLI/compendium/spells/barkskin-xphb.md),\
    ...
    \ each: [entangle](Misc%20Files/CLI/compendium/spells/entangle-xphb.md), [goodberry](Misc%20Files/CLI/compendium/spells/goodberry-xphb.md)"
...
- "desc": "The dryad targets one humanoid or beast that she can see within 30 feet\
    ...
    \ throw or be magically [charmed](Misc%20Files/CLI/rules/conditions.md#Charmed).\
    \ The [charmed](Misc%20Files/CLI/rules/conditions.md#Charmed) creature regards\
    ...
    \ than one humanoid and up to three beasts [charmed](Misc%20Files/CLI/rules/conditions.md#Charmed)\
    \ at a time."
  "name": "Fey Charm"
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/fey/token/dryad.webp"
```
^statblock
