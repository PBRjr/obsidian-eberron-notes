...
aliases: ["Fey Spirit"]
---
# [Fey Spirit](Misc Files\CLI\compendium\bestiary\fey/fey-spirit-xphb.md)
...
- "desc": "The spirit magically teleports up to 30 feet to an unoccupied space it\
    ...
    \ Failure: The target is [Charmed](Misc%20Files/CLI/rules/conditions.md#Charmed)\
...
"source":
- "XPHB"
"image": "Misc%20Files/CLI/compendium/bestiary/fey/token/fey-spirit-xphb.webp"
```
^statblock