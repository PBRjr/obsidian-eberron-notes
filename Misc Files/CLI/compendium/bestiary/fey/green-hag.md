...
aliases: ["Green Hag"]
---
# [Green Hag](Misc Files\CLI\compendium\bestiary\fey/green-hag.md)
...
> 
> 1st level (4 slots): [identify](Misc%20Files/CLI/compendium/spells/identify-xphb.md), [ray of sickness](Misc%20Files/CLI/compendium/spells/ray-of-sickness-xphb.md)  
> 2nd level (3 slots): [hold person](Misc%20Files/CLI/compendium/spells/hold-person-xphb.md), [locate object](Misc%20Files/CLI/compendium/spells/locate-object-xphb.md)  
> 3rd level (3 slots): [bestow curse](Misc%20Files/CLI/compendium/spells/bestow-curse-xphb.md), [counterspell](Misc%20Files/CLI/compendium/spells/counterspell-xphb.md), [lightning bolt](Misc%20Files/CLI/compendium/spells/lightning-bolt-xphb.md)  
> 4th level (3 slots): [phantasmal killer](Misc%20Files/CLI/compendium/spells/phantasmal-killer-xphb.md), [polymorph](Misc%20Files/CLI/compendium/spells/polymorph-xphb.md)  
> 5th level (2 slots): [contact other plane](Misc%20Files/CLI/compendium/spells/contact-other-plane-xphb.md), [scrying](Misc%20Files/CLI/compendium/spells/scrying-xphb.md)  
> 6th level (1 slot): [eyebite](Misc%20Files/CLI/compendium/spells/eyebite-xphb.md)  
> 
> For casting these spells, each hag is a 12th-level spellcaster that uses Intelligence as her spellcasting ability. The spell save DC is 12 + the hag's Intelligence modifier, and the spell attack bonus is 4 + the hag's Intelligence modifier.
> 
> **Hag Eye.** A hag coven can craft a magic item called a hag eye, which is made from a real eye coated in varnish and often fitted to a pendant or other wearable item. The hag eye is usually entrusted to a minion for safekeeping and transport. A hag in the coven can take an action to see what the hag eye sees if the hag eye is on the same plane of existence. A hag eye has AC 10, 1 hit point, and [darkvision](Misc%20Files/CLI/rules/senses.md#Darkvision) with a radius of 60 feet. If it is destroyed, each coven member takes `3d10` psychic damage and is [blinded](Misc%20Files/CLI/rules/conditions.md#Blinded) for 24 hours.
> 
> A hag coven can have only one hag eye at a time, and creating a new one requires all three members of the coven to perform a ritual. The ritual takes 1 hour, and the hags can't perform it while [blinded](Misc%20Files/CLI/rules/conditions.md#Blinded). During the ritual, if the hags take any action other than performing the ritual, they must start over.
^hag-covens
...
- "desc": "The hag can mimic animal sounds and humanoid voices. A creature that hears\
    \ the sounds can tell they are imitations with a successful DC 14 Wisdom ([Insight](Misc%20Files/CLI/rules/skills.md#Insight))\
    \ check."
  "name": "Mimicry"
"actions":
...
- "desc": "The hag covers herself and anything she is wearing or carrying with a magical\
    ...
    \ visually inspect the illusion and succeed on a DC 20 Intelligence ([Investigation](Misc%20Files/CLI/rules/skills.md#Investigation))\
    \ check to discern that the hag is disguised."
  "name": "Illusory Appearance"
- "desc": "The hag magically turns [invisible](Misc%20Files/CLI/rules/conditions.md#Invisible)\
    \ until she attacks or casts a spell, or until her [concentration](Misc%20Files/CLI/rules/conditions.md#Concentration)\
    \ ends (as if [concentrating](Misc%20Files/CLI/rules/conditions.md#Concentration)\
    \ on a spell). While [invisible](Misc%20Files/CLI/rules/conditions.md#Invisible),\
    \ she leaves no physical evidence of her passage, so she can be tracked only by\
    \ magic. Any equipment she wears or carries is [invisible](Misc%20Files/CLI/rules/conditions.md#Invisible)\
    \ with her."
...
- "desc": "- Birds, rodents, snakes, spiders, or toads (or some other creatures appropriate\
    ...
    \ score of 2 or lower are [charmed](Misc%20Files/CLI/rules/conditions.md#Charmed)\
...
- "desc": "- Illusory duplicates of the hag appear in random places at random times\
    ...
    \ are thick with reeking mud.  \n- Trees transform into [awakened trees](Misc%20Files/CLI/compendium/bestiary/plant/awakened-tree.md)\
    \ and attack when hostile intruders are near.  "
  "name": ""
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/fey/token/green-hag.webp"
```
^statblock
