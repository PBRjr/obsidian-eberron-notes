...
- [Divination](Misc%20Files/CLI/compendium/spells/divination-xphb.md) spells cast within the lair by creatures other than the mummy lord have a 25 percent chance to provide misleading results, as determined by the DM. If a [divination](Misc%20Files/CLI/compendium/spells/divination-xphb.md) spell already has a chance to fail or become unreliable when cast multiple times, that chance increases by 25 percent.  
- A creature that takes treasure from the lair is cursed until the treasure is returned. The cursed target has disadvantage on all saving throws. The curse lasts until removed by a [remove curse](Misc%20Files/CLI/compendium/spells/remove-curse-xphb.md) spell or other magic.  
