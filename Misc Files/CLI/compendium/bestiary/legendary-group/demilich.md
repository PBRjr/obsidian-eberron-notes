...
- The tomb trembles violently for a moment. Each creature on the floor of the tomb must succeed on a DC 19 Dexterity saving throw or be knocked [prone](Misc%20Files/CLI/rules/conditions.md#Prone).  
- The demilich targets one creature it can see within 60 feet of it. An [antimagic field](Misc%20Files/CLI/compendium/spells/antimagic-field-xphb.md) fills the space of the target, moving with it until initiative count 20 on the next round.  
...
- Monsters in the tomb have advantage on saving throws against being [charmed](Misc%20Files/CLI/rules/conditions.md#Charmed) or [frightened](Misc%20Files/CLI/rules/conditions.md#Frightened), and against features that turn undead.  
