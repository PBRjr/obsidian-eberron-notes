...
aliases: ["Empyrean"]
---
# [Empyrean](Misc Files\CLI\compendium\bestiary\celestial/empyrean.md)
...
- "desc": "The empyrean's innate spellcasting ability is Charisma (spell save DC 23,\
    ...
    \ requiring no material components:\n\nAt will: [greater restoration](Misc%20Files/CLI/compendium/spells/greater-restoration-xphb.md),\
    ...
    \ each: [commune](Misc%20Files/CLI/compendium/spells/commune-xphb.md), [dispel\
    \ evil and good](Misc%20Files/CLI/compendium/spells/dispel-evil-and-good-xphb.md),\
    \ [earthquake](Misc%20Files/CLI/compendium/spells/earthquake-xphb.md), [fire storm](Misc%20Files/CLI/compendium/spells/fire-storm-xphb.md),\
...
- "desc": "Melee Weapon Attack: +17 to hit, reach 10 ft., one target. Hit: 31\
    ...
    \ on a DC 15 Constitution saving throw or be [stunned](Misc%20Files/CLI/rules/conditions.md#Stunned)\
...
- "desc": "The empyrean bolsters all nonhostile creatures within 120 feet of it until\
    \ the end of its next turn. Bolstered creatures can't be [charmed](Misc%20Files/CLI/rules/conditions.md#Charmed)\
    \ or [frightened](Misc%20Files/CLI/rules/conditions.md#Frightened), and they gain\
...
- "desc": "The empyrean strikes the ground with its maul, triggering an earth tremor.\
    ...
    \ on a DC 25 Strength saving throw or be knocked [prone](Misc%20Files/CLI/rules/conditions.md#Prone)."
  "name": "Trembling Strike (Costs 2 Actions)"
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/celestial/token/empyrean.webp"
```
^statblock