...
aliases: ["Pentadrone"]
---
# [Pentadrone](Misc Files\CLI\compendium\bestiary\construct/pentadrone.md)
...
- "desc": "The pentadrone exhales a 30-foot cone of gas. Each creature in that area\
    \ must succeed on a DC 11 Constitution saving throw or be [paralyzed](Misc%20Files/CLI/rules/conditions.md#Paralyzed)\
    \ for 1 minute. A creature can repeat the saving throw at the end of each of its\
    \ turns, ending the effect on itself on a success."
  "name": "Paralysis Gas (Recharge 5-6)"
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/construct/token/pentadrone.webp"
```
^statblock