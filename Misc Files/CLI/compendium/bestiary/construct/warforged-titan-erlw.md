...
---
# [Warforged Titan](Misc Files\CLI\compendium\bestiary\construct/warforged-titan-erlw.md)
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 10 ft., one target. Hit: 19\
    ...
    \ is [prone](Misc%20Files/CLI/rules/conditions.md#Prone)."
  "name": "Axehand"
- "desc": "Melee Weapon Attack: +9 to hit, reach 10 ft., one target. Hit: 19\
...
"source":
- "ERLW"
"image": "Misc%20Files/CLI/compendium/bestiary/construct/token/warforged-titan-erlw.webp"
```
^statblock