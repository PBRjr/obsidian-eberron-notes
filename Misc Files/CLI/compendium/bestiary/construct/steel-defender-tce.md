...
---
# [Steel Defender](Misc Files\CLI\compendium\bestiary\construct/steel-defender-tce.md)
...
"traits":
- "desc": "The defender can't be [surprised](Misc%20Files/CLI/rules/conditions.md#Surprised)."
  "name": "Vigilant"
"actions":
...
- "TCE"
- "ERLW"
"image": "Misc%20Files/CLI/compendium/bestiary/construct/token/steel-defender-tce.webp"
```
^statblock