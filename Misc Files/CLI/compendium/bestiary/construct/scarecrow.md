...
aliases: ["Scarecrow"]
---
# [Scarecrow](Misc Files\CLI\compendium\bestiary\construct/scarecrow.md)
...
- "desc": "Melee Weapon Attack: +3 to hit, reach 5 ft., one target. Hit: 6 (2d4\
    ...
    \ 11 Wisdom saving throw or be [frightened](Misc%20Files/CLI/rules/conditions.md#Frightened)\
...
- "desc": "The scarecrow targets one creature it can see within 30 feet of it. If\
    ...
    \ saving throw or be magically [frightened](Misc%20Files/CLI/rules/conditions.md#Frightened)\
    \ until the end of the scarecrow's next turn. The [frightened](Misc%20Files/CLI/rules/conditions.md#Frightened)\
    \ target is [paralyzed](Misc%20Files/CLI/rules/conditions.md#Paralyzed)."
  "name": "Terrifying Glare"
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/construct/token/scarecrow.webp"
```
^statblock
