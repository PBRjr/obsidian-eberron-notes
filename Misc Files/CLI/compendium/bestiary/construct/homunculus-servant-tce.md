...
---
# [Homunculus Servant](Misc Files\CLI\compendium\bestiary\construct/homunculus-servant-tce.md)
...
- "desc": "If the homunculus is subjected to an effect that allows it to make a Dexterity\
    ...
    \ if it's [incapacitated](Misc%20Files/CLI/rules/conditions.md#Incapacitated)."
  "name": "Evasion"
"actions":
...
- "TCE"
- "ERLW"
"image": "Misc%20Files/CLI/compendium/bestiary/construct/token/homunculus-servant-tce.webp"
```
^statblock