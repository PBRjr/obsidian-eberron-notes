...
aliases: ["Homunculus"]
---
# [Homunculus](Misc Files\CLI\compendium\bestiary\construct/homunculus.md)
*Source: Monster Manual p. 188, Eberron: Rising from the Last War. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
- "desc": "Melee Weapon Attack: +4 to hit, reach 5 ft., one creature. Hit: 1\
    ...
    \ minute. If the saving throw fails by 5 or more, the target is instead [poisoned](Misc%20Files/CLI/rules/conditions.md#Poisoned)\
    \ for 5 (1d10) minutes and [unconscious](Misc%20Files/CLI/rules/conditions.md#Unconscious)\
    \ while [poisoned](Misc%20Files/CLI/rules/conditions.md#Poisoned) in this way."
  "name": "Bite"
"source":
- "MM"
- "ERLW"
"image": "Misc%20Files/CLI/compendium/bestiary/construct/token/homunculus.webp"
```
^statblock