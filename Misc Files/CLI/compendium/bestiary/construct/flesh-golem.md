...
aliases: ["Flesh Golem"]
---
# [Flesh Golem](Misc Files\CLI\compendium\bestiary\construct/flesh-golem.md)
...
- "desc": "Whenever the golem starts its turn with 40 hit points or fewer, roll a\
    ...
    \ a DC 15 Charisma ([Persuasion](Misc%20Files/CLI/rules/skills.md#Persuasion))\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/construct/token/flesh-golem.webp"
```
^statblock