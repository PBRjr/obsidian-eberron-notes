...
---
# [Bestial Spirit](Misc Files\CLI\compendium\bestiary\beast/bestial-spirit-xphb.md)
...
- "desc": "The spirit has Advantage on an attack roll against a creature if at least\
    ...
    \ have the [Incapacitated](Misc%20Files/CLI/rules/conditions.md#Incapacitated)\
    \ condition."
...
"source":
- "XPHB"
"image": "Misc%20Files/CLI/compendium/bestiary/beast/token/bestial-spirit-xphb.webp"
```
^statblock