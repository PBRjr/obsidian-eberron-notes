...
---
# [Swarm of Centipedes](Misc Files\CLI\compendium\bestiary\beast/swarm-of-centipedes.md)
...
- "desc": "Melee Weapon Attack: +3 to hit, reach 0 ft., one target in the swarm's\
    ...
    \ by a swarm of centipedes is stable but [poisoned](Misc%20Files/CLI/rules/conditions.md#Poisoned)\
    \ for 1 hour, even after regaining hit points, and [paralyzed](Misc%20Files/CLI/rules/conditions.md#Paralyzed)\
    \ while [poisoned](Misc%20Files/CLI/rules/conditions.md#Poisoned) in this way."
  "name": "Bites"
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/beast/token/swarm-of-centipedes.webp"
```
^statblock
