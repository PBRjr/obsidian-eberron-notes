...
---
# [Beast of the Land](Misc Files\CLI\compendium\bestiary\beast/beast-of-the-land-xphb.md)
...
- "desc": "Melee Attack Roll: YourSpellAttack Bonus equals your spell attack modifier,\
    ...
    \ an extra 1d6 damage of the same type, and the target has the [Prone](Misc%20Files/CLI/rules/conditions.md#Prone)\
    \ condition if it is a Large or smaller creature."
  "name": "Beast's Strike"
"source":
- "XPHB"
"image": "Misc%20Files/CLI/compendium/bestiary/beast/token/beast-of-the-land-xphb.webp"
```
^statblock