...
aliases: ["Giant Frog"]
---
# [Giant Frog](Misc Files\CLI\compendium\bestiary\beast/giant-frog.md)
...
- "desc": "Melee Weapon Attack: +3 to hit, reach 5 ft., one target. Hit: 4 (1d6\
    \ + 1) piercing damage, and the target is [grappled](Misc%20Files/CLI/rules/conditions.md#Grappled)\
    \ (escape DC 11). Until this grapple ends, the target is [restrained](Misc%20Files/CLI/rules/conditions.md#Restrained),\
...
- "desc": "The frog makes one bite attack against a Small or smaller target it is\
    ...
    \ The swallowed target is [blinded](Misc%20Files/CLI/rules/conditions.md#Blinded)\
    ...
    \ longer [restrained](Misc%20Files/CLI/rules/conditions.md#Restrained) by it and\
    \ can escape from the corpse using 5 feet of movement, exiting [prone](Misc%20Files/CLI/rules/conditions.md#Prone)."
  "name": "Swallow"
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/beast/token/giant-frog.webp"
```
^statblock
