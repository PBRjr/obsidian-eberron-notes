...
---
# [Constrictor Snake](Misc Files\CLI\compendium\bestiary\beast/constrictor-snake-xmm.md)
...
- "desc": "Strength Saving Throw: DC 12, one Medium or smaller creature the snake\
    ...
    \ has the [Grappled](Misc%20Files/CLI/rules/conditions.md#Grappled) condition\
    \ (escape DC 12)."
  "name": "Constrict"
"source":
- "XMM"
- "XPHB"
"image": "Misc%20Files/CLI/compendium/bestiary/beast/token/constrictor-snake-xmm.webp"
```
^statblock
