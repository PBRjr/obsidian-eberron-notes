...
---
# [Giant Insect](Misc Files\CLI\compendium\bestiary\beast/giant-insect-xphb.md)
...
- "desc": "Constitution Saving Throw: Your spell save DC, one creature the insect\
    \ can see within 10 feet. Failure: The target has the [Poisoned](Misc%20Files/CLI/rules/conditions.md#Poisoned)\
    \ condition until the start of the insect's next turn."
  "name": "Venomous Spew (Centipede Only)"
"source":
- "XPHB"
"image": "Misc%20Files/CLI/compendium/bestiary/beast/token/giant-insect-xphb.webp"
```
^statblock