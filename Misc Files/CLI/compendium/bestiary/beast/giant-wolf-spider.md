...
---
# [Giant Wolf Spider](Misc Files\CLI\compendium\bestiary\beast/giant-wolf-spider.md)
...
- "desc": "Melee Weapon Attack: +3 to hit, reach 5 ft., one creature. Hit: 4\
    ...
    \ the target is stable but [poisoned](Misc%20Files/CLI/rules/conditions.md#Poisoned)\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/beast/token/giant-wolf-spider.webp"
```
^statblock
