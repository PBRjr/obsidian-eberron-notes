...
aliases: ["Frog"]
---
# [Frog](Misc Files\CLI\compendium\bestiary\beast/frog-xmm.md)
...
- "desc": "The frog can breathe air and water."
  "name": "Amphibious"
- "desc": "The frog's [Long Jump](Misc%20Files/CLI/rules/variant-rules/long-jump-xphb.md)\
    \ is up to 10 feet and its [High Jump](Misc%20Files/CLI/rules/variant-rules/high-jump-xphb.md)\
...
- "XMM"
- "XPHB"
"image": "Misc%20Files/CLI/compendium/bestiary/beast/token/frog-xmm.webp"
```
^statblock
