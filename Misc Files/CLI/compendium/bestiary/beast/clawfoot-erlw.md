...
aliases: ["Clawfoot"]
---
# [Clawfoot](Misc Files\CLI\compendium\bestiary\beast/clawfoot-erlw.md)
...
- "desc": "If the clawfoot moves at least 20 feet straight toward a creature and then\
    ...
    \ 11 Strength saving throw or be knocked [prone](Misc%20Files/CLI/rules/conditions.md#Prone).\
    \ If the target is [prone](Misc%20Files/CLI/rules/conditions.md#Prone), the clawfoot\
...
"source":
- "ERLW"
"image": "Misc%20Files/CLI/compendium/bestiary/beast/token/clawfoot-erlw.webp"
```
^statblock