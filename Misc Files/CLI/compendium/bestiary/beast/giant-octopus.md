...
---
# [Giant Octopus](Misc Files\CLI\compendium\bestiary\beast/giant-octopus.md)
...
- "desc": "While out of water, the octopus can hold its breath for 1 hour."
  "name": "Hold Breath"
- "desc": "The octopus has advantage on Dexterity ([Stealth](Misc%20Files/CLI/rules/skills.md#Stealth))\
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 15 ft., one target. Hit: 10\
    \ (2d6 + 3) bludgeoning damage. If the target is a creature, it is [grappled](Misc%20Files/CLI/rules/conditions.md#Grappled)\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/beast/token/giant-octopus.webp"
```
^statblock
