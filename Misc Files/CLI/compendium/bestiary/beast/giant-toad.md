...
aliases: ["Giant Toad"]
---
# [Giant Toad](Misc Files\CLI\compendium\bestiary\beast/giant-toad.md)
...
- "desc": "Melee Weapon Attack: +4 to hit, reach 5 ft., one target. Hit: 7 (1d10\
    \ + 2) piercing damage plus 5 (1d10) poison damage, and the target is [grappled](Misc%20Files/CLI/rules/conditions.md#Grappled)\
...
- "desc": "The toad makes one bite attack against a Medium or smaller target it is\
    ...
    \ no longer [restrained](Misc%20Files/CLI/rules/conditions.md#Restrained) by it\
    \ and can escape from the corpse using 5 feet of movement, exiting [prone](Misc%20Files/CLI/rules/conditions.md#Prone)."
  "name": "Swallow"
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/beast/token/giant-toad.webp"
```
^statblock
