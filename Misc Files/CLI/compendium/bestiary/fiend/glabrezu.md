...
aliases: ["Glabrezu"]
---
# [Glabrezu](Misc Files\CLI\compendium\bestiary\fiend/glabrezu.md)
...
- "desc": "The glabrezu's spellcasting ability is Intelligence (spell save DC 16).\
    ...
    \ [detect magic](Misc%20Files/CLI/compendium/spells/detect-magic-xphb.md), [dispel\
    \ magic](Misc%20Files/CLI/compendium/spells/dispel-magic-xphb.md)\n\n1/day each:\
    \ [confusion](Misc%20Files/CLI/compendium/spells/confusion-xphb.md), [fly](Misc%20Files/CLI/compendium/spells/fly-xphb.md),\
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 10 ft., one target. Hit: 16\
    ...
    \ it is [grappled](Misc%20Files/CLI/rules/conditions.md#Grappled) (escape DC 15).\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/fiend/token/glabrezu.webp"
```
^statblock