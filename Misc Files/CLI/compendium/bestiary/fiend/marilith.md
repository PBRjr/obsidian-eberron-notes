...
aliases: ["Marilith"]
---
# [Marilith](Misc Files\CLI\compendium\bestiary\fiend/marilith.md)
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 10 ft., one creature. Hit:\
    ...
    \ [grappled](Misc%20Files/CLI/rules/conditions.md#Grappled) (escape DC 19). Until\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/fiend/token/marilith.webp"
```
^statblock