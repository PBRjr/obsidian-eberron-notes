...
aliases: ["Lemure"]
---
# [Lemure](Misc Files\CLI\compendium\bestiary\fiend/lemure.md)
...
- "desc": "A lemure that dies in the Nine Hells comes back to life with all its hit\
    ...
    \ [bless](Misc%20Files/CLI/compendium/spells/bless-xphb.md) spell cast on that\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/fiend/token/lemure.webp"
```
^statblock