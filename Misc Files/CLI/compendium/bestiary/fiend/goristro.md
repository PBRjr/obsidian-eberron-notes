...
aliases: ["Goristro"]
---
# [Goristro](Misc Files\CLI\compendium\bestiary\fiend/goristro.md)
...
- "desc": "If the goristro moves at least 15 feet straight toward a target and then\
    ...
    \ saving throw or be pushed up to 20 feet away and knocked [prone](Misc%20Files/CLI/rules/conditions.md#Prone)."
  "name": "Charge"
...
- "desc": "Melee Weapon Attack: +13 to hit, reach 5 ft., one target. Hit: 23\
    ...
    \ on a DC 21 Strength saving throw or be knocked [prone](Misc%20Files/CLI/rules/conditions.md#Prone)."
  "name": "Hoof"
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/fiend/token/goristro.webp"
```
^statblock