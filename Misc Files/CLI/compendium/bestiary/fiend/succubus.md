...
aliases: ["Succubus"]
---
# [Succubus](Misc Files\CLI\compendium\bestiary\fiend/succubus.md)
*Source: Monster Manual p. 285, Eberron: Rising from the Last War. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
The succubus or incubus resorts to charming a victim magically only when necessary, usually as a form of self-defense. A [charmed](Misc%20Files/CLI/rules/conditions.md#Charmed) creature isn't responsible for its actions, so forcing it to behave against its will won't bring the fiend closer to the ultimate prize: the victim's soul.
...
Succubi and incubi can reproduce with one another to spawn more of their kind. Less commonly, a succubus or incubus reproduces with a humanoid. From this unholy union, a [cambion](Misc%20Files/CLI/compendium/bestiary/fiend/cambion.md) child is conceived. Invariably, the fiendish offspring is as wicked as its fiendish parent.
...
- "desc": "The fiend ignores the range restriction on its telepathy when communicating\
    \ with a creature it has [charmed](Misc%20Files/CLI/rules/conditions.md#Charmed).\
...
- "desc": "One humanoid the fiend can see within 30 feet of it must succeed on a DC\
    \ 15 Wisdom saving throw or be magically [charmed](Misc%20Files/CLI/rules/conditions.md#Charmed)\
    ...
    \ hours.\n\nThe fiend can have only one target [charmed](Misc%20Files/CLI/rules/conditions.md#Charmed)\
    \ at a time. If it charms another, the effect on the previous target ends."
  "name": "Charm"
- "desc": "The fiend kisses a creature [charmed](Misc%20Files/CLI/rules/conditions.md#Charmed)\
...
- "MM"
- "ERLW"
"image": "Misc%20Files/CLI/compendium/bestiary/fiend/token/succubus.webp"
```
^statblock
