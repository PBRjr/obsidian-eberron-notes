...
aliases: ["Chasme"]
---
# [Chasme](Misc Files\CLI\compendium\bestiary\fiend/chasme.md)
...
- "desc": "The chasme produces a horrid droning sound to which demons are immune.\
    ...
    \ on a DC 12 Constitution saving throw or fall [unconscious](Misc%20Files/CLI/rules/conditions.md#Unconscious)\
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one creature. Hit: 16\
    ...
    \ a long rest or until it is affected by a spell like  [greater restoration](Misc%20Files/CLI/compendium/spells/greater-restoration-xphb.md)."
  "name": "Proboscis"
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/fiend/token/chasme.webp"
```
^statblock