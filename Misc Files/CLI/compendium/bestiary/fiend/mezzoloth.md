...
aliases: ["Mezzoloth"]
---
# [Mezzoloth](Misc Files\CLI\compendium\bestiary\fiend/mezzoloth.md)
...
- "desc": "The mezzoloth's innate spellcasting ability is Charisma (spell save DC\
    ...
    \ components:\n\n1/day: [cloudkill](Misc%20Files/CLI/compendium/spells/cloudkill-xphb.md)\n\
    \n2/day each: [darkness](Misc%20Files/CLI/compendium/spells/darkness-xphb.md),\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/fiend/token/mezzoloth.webp"
```
^statblock