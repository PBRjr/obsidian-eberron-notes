...
---
# [Zakya Rakshasa](Misc Files\CLI\compendium\bestiary\fiend/zakya-rakshasa-erlw.md)
...
- "desc": "The rakshasa's innate spellcasting ability is Charisma (spell save DC 11).\
    ...
    1/day: [shield](Misc%20Files/CLI/compendium/spells/shield-xphb.md)"
...
- "desc": "When the rakshasa hits a creature with a melee weapon attack, the attack\
    ...
    \ creature up to 10 feet away from it, knock the creature [prone](Misc%20Files/CLI/rules/conditions.md#Prone),\
...
"source":
- "ERLW"
"image": "Misc%20Files/CLI/compendium/bestiary/fiend/token/zakya-rakshasa-erlw.webp"
```
^statblock