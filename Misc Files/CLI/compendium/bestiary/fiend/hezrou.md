...
aliases: ["Hezrou"]
---
# [Hezrou](Misc Files\CLI\compendium\bestiary\fiend/hezrou.md)
...
- "desc": "Any creature that starts its turn within 10 feet of the hezrou must succeed\
    \ on a DC 14 Constitution saving throw or be [poisoned](Misc%20Files/CLI/rules/conditions.md#Poisoned)\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/fiend/token/hezrou.webp"
```
^statblock