...
---
# [Bearded Devil](Misc Files\CLI\compendium\bestiary\fiend/bearded-devil.md)
...
- "desc": "The devil can't be [frightened](Misc%20Files/CLI/rules/conditions.md#Frightened)\
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 10 ft., one target. Hit: 8\
    ...
    \ the wound with a successful DC 12 Wisdom ([Medicine](Misc%20Files/CLI/rules/skills.md#Medicine))\
    \ check. The wound also closes if the target receives magical healing."
  "name": "Glaive"
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/fiend/token/bearded-devil.webp"
```
^statblock