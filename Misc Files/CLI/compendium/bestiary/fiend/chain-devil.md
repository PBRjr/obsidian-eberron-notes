...
aliases: ["Chain Devil"]
---
# [Chain Devil](Misc Files\CLI\compendium\bestiary\fiend/chain-devil.md)
...
- "desc": "Melee Weapon Attack: +8 to hit, reach 10 ft., one target. Hit: 11\
    \ (2d6 + 4) slashing damage. The target is [grappled](Misc%20Files/CLI/rules/conditions.md#Grappled)\
    \ (escape DC 14) if the devil isn't already grappling a creature. Until this grapple\
    \ ends, the target is [restrained](Misc%20Files/CLI/rules/conditions.md#Restrained)\
...
- "desc": "When a creature the devil can see starts its turn within 30 feet of the\
    ...
    \ must succeed on a DC 14 Wisdom saving throw or be [frightened](Misc%20Files/CLI/rules/conditions.md#Frightened)\
    \ until the end of its turn."
  "name": "Unnerving Mask"
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/fiend/token/chain-devil.webp"
```
^statblock