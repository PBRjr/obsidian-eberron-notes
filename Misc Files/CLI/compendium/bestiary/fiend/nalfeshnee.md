...
aliases: ["Nalfeshnee"]
---
# [Nalfeshnee](Misc Files\CLI\compendium\bestiary\fiend/nalfeshnee.md)
...
- "desc": "The nalfeshnee magically emits scintillating, multicolored light. Each\
    ...
    \ on a DC 15 Wisdom saving throw or be [frightened](Misc%20Files/CLI/rules/conditions.md#Frightened)\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/fiend/token/nalfeshnee.webp"
```
^statblock