...
aliases: ["Night Hag"]
---
# [Night Hag](Misc Files\CLI\compendium\bestiary\fiend/night-hag.md)
...
- "desc": "The hag's innate spellcasting ability is Charisma (spell save DC 14, +6\
    ...
    2/day each: [plane shift](Misc%20Files/CLI/compendium/spells/plane-shift-xphb.md)\
    \ (self only), [ray of enfeeblement](Misc%20Files/CLI/compendium/spells/ray-of-enfeeblement-xphb.md),\
...
- "desc": "While on the Ethereal Plane, the hag magically touches a sleeping humanoid\
    \ on the Material Plane. A [protection from evil and good](Misc%20Files/CLI/compendium/spells/protection-from-evil-and-good-xphb.md)\
    ...
    \ lasts until removed by the  [greater restoration](Misc%20Files/CLI/compendium/spells/greater-restoration-xphb.md)\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/fiend/token/night-hag.webp"
```
^statblock