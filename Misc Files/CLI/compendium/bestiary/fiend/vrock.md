...
aliases: ["Vrock"]
---
# [Vrock](Misc Files\CLI\compendium\bestiary\fiend/vrock.md)
...
- "desc": "A 15-foot-radius cloud of toxic spores extends out from the vrock. The\
    ...
    \ 14 Constitution saving throw or become [poisoned](Misc%20Files/CLI/rules/conditions.md#Poisoned).\
...
- "desc": "The vrock emits a horrific screech. Each creature within 20 feet of it\
    ...
    \ saving throw or be [stunned](Misc%20Files/CLI/rules/conditions.md#Stunned) until\
    \ the end of the vrock's next turn."
  "name": "Stunning Screech (1/Day)"
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/fiend/token/vrock.webp"
```
^statblock