...
aliases: ["Erinyes"]
---
# [Erinyes](Misc Files\CLI\compendium\bestiary\fiend/erinyes.md)
...
> 
> Some erinyes carry a [rope of entanglement](Misc%20Files/CLI/compendium/items/rope-of-entanglement-xdmg.md) (detailed in the Dungeon Master's Guide). When such an erinyes uses its Multiattack, the erinyes can use the rope in place of two of the attacks.
...
> 
> Though devils all have common names, every devil above a lemure in station also has a true name that it keeps secret. A devil can be forced to disclose its true name if [charmed](Misc%20Files/CLI/rules/conditions.md#Charmed), and ancient scrolls and tomes are said to exist that list the true names of certain devils.
> 
...
- "desc": "Ranged Weapon Attack: +7 to hit, range 150/600 ft., one target. Hit:\
    ...
    \ must succeed on a DC 14 Constitution saving throw or be [poisoned](Misc%20Files/CLI/rules/conditions.md#Poisoned).\
    \ The poison lasts until it is removed by the [lesser restoration](Misc%20Files/CLI/compendium/spells/lesser-restoration-xphb.md)\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/fiend/token/erinyes.webp"
```
^statblock