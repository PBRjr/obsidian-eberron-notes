...
aliases: ["Ice Devil"]
---
# [Ice Devil](Misc Files\CLI\compendium\bestiary\fiend/ice-devil.md)
...
- "desc": "The devil magically forms an opaque wall of ice on a solid surface it can\
    ...
    \ creature is [incapacitated](Misc%20Files/CLI/rules/conditions.md#Incapacitated).\
    \ The creature then makes a DC 17 Dexterity saving throw, taking 35 (10d6) cold\
    \ damage on a failed save, or half as much damage on a successful one.\n\nThe\
    \ wall lasts for 1 minute or until the devil is [incapacitated](Misc%20Files/CLI/rules/conditions.md#Incapacitated)\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/fiend/token/ice-devil.webp"
```
^statblock