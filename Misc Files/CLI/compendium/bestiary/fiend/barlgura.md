...
aliases: ["Barlgura"]
---
# [Barlgura](Misc Files\CLI\compendium\bestiary\fiend/barlgura.md)
...
- "desc": "The barlgura's spellcasting ability is Wisdom (spell save DC 13). The barlgura\
    ...
    1/day each: [entangle](Misc%20Files/CLI/compendium/spells/entangle-xphb.md),\
    \ [phantasmal force](Misc%20Files/CLI/compendium/spells/phantasmal-force-xphb.md)\n\
    \n2/day each: [disguise self](Misc%20Files/CLI/compendium/spells/disguise-self-xphb.md),\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/fiend/token/barlgura.webp"
```
^statblock