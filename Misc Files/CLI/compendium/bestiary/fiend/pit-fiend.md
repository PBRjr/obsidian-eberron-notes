...
aliases: ["Pit Fiend"]
---
# [Pit Fiend](Misc Files\CLI\compendium\bestiary\fiend/pit-fiend.md)
...
- "desc": "The pit fiend's spellcasting ability is Charisma (spell save DC 21). The\
    ...
    \ [hold monster](Misc%20Files/CLI/compendium/spells/hold-monster-xphb.md), [wall\
    \ of fire](Misc%20Files/CLI/compendium/spells/wall-of-fire-xphb.md)"
...
- "desc": "Any creature hostile to the pit fiend that starts its turn within 20 feet\
    ...
    \ is [incapacitated](Misc%20Files/CLI/rules/conditions.md#Incapacitated). On a\
    \ failed save, the creature is [frightened](Misc%20Files/CLI/rules/conditions.md#Frightened)\
...
- "desc": "Melee Weapon Attack: +14 to hit, reach 5 ft., one target. Hit: 22\
    ...
    \ saving throw or become [poisoned](Misc%20Files/CLI/rules/conditions.md#Poisoned).\
    ...
    \ the start of each of its turns. The [poisoned](Misc%20Files/CLI/rules/conditions.md#Poisoned)\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/fiend/token/pit-fiend.webp"
```
^statblock