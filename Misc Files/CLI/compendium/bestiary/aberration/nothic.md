...
aliases: ["Nothic"]
---
# [Nothic](Misc Files\CLI\compendium\bestiary\aberration/nothic.md)
...
"cr": "2"
"traits":
- "desc": "The nothic has advantage on Wisdom ([Perception](Misc%20Files/CLI/rules/skills.md#Perception))\
...
- "desc": "The nothic targets one creature it can see within 30 feet of it. The target\
  ...
  "name": "Rotting Gaze"
- "desc": "The nothic targets one creature it can see within 30 feet of it. The target\
    \ must contest its Charisma ([Deception](Misc%20Files/CLI/rules/skills.md#Deception))\
    \ check against the nothic's Wisdom ([Insight](Misc%20Files/CLI/rules/skills.md#Insight))\
    \ check. If the nothic wins, it magically learns one fact or secret about the\
    \ target. The target automatically wins if it is immune to being [charmed](Misc%20Files/CLI/rules/conditions.md#Charmed)."
  "name": "Weird Insight"
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/aberration/token/nothic.webp"
```
^statblock
