...
aliases: ["Beholder"]
---
# [Beholder](Misc Files\CLI\compendium\bestiary\aberration/beholder.md)
*Source: Monster Manual p. 28, Eberron: Rising from the Last War*  
...
As alien as their creator, the rooms in a beholder's lair reflect the creature's arrogance. It festoons its chambers with trophies from the battles it has won, including [petrified](Misc%20Files/CLI/rules/conditions.md#Petrified) adventurers standing frozen in their horrified final moments, pieces of other beholders, and magic items wrested from powerful foes. A beholder judges its own worth by its acquisitions, and it never willingly parts with its treasures.
...
- "desc": "The beholder's central eye creates an area of antimagic, as in the [antimagic\
    \ field](Misc%20Files/CLI/compendium/spells/antimagic-field-xphb.md) spell, in\
    \ a 150-foot cone. At the start of each of its turns, the beholder decides which\
    \ way the cone faces and whether the cone is active. The area works against the\
...
- "desc": "The beholder shoots three of the following magical eye rays at random (reroll\
    ...
    \ throw or be [charmed](Misc%20Files/CLI/rules/conditions.md#Charmed) by the beholder\
    ...
    \ [paralyzed](Misc%20Files/CLI/rules/conditions.md#Paralyzed) for 1 minute. The\
    ...
    \ direction. It is [restrained](Misc%20Files/CLI/rules/conditions.md#Restrained)\
    \ by the ray's telekinetic grip until the start of the beholder's next turn or\
    \ until the beholder is [incapacitated](Misc%20Files/CLI/rules/conditions.md#Incapacitated).\
    ...
    \ must succeed on a DC 16 Wisdom saving throw or fall asleep and remain [unconscious](Misc%20Files/CLI/rules/conditions.md#Unconscious)\
    ...
    \ [restrained](Misc%20Files/CLI/rules/conditions.md#Restrained). It must repeat\
    \ the saving throw at the end of its next turn. On a success, the effect ends.\
    \ On a failure, the creature is [petrified](Misc%20Files/CLI/rules/conditions.md#Petrified)\
...
- "desc": "- A 50-foot-square area of ground within 120 feet of the beholder becomes\
    ...
    \ DC 15 Dexterity saving throw or be [grappled](Misc%20Files/CLI/rules/conditions.md#Grappled).\
    \ Escaping requires a successful DC 15 Strength ([Athletics](Misc%20Files/CLI/rules/skills.md#Athletics))\
...
- "MM"
- "ERLW"
"image": "Misc%20Files/CLI/compendium/bestiary/aberration/token/beholder.webp"
```
^statblock
