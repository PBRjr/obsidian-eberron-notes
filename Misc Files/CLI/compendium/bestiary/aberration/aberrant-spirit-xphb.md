...
---
# [Aberrant Spirit](Misc Files\CLI\compendium\bestiary\aberration/aberrant-spirit-xphb.md)
...
- "desc": "At the start of each of the spirit's turns, the spirit emits psionic energy\
    \ if it doesn't have the [Incapacitated](Misc%20Files/CLI/rules/conditions.md#Incapacitated)\
...
"source":
- "XPHB"
"image": "Misc%20Files/CLI/compendium/bestiary/aberration/token/aberrant-spirit-xphb.webp"
```
^statblock