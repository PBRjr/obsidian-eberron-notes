...
aliases: ["Cloaker"]
---
# [Cloaker](Misc Files\CLI\compendium\bestiary\aberration/cloaker.md)
...
- "desc": "While in bright light, the cloaker has disadvantage on attack rolls and\
    \ Wisdom ([Perception](Misc%20Files/CLI/rules/skills.md#Perception)) checks that\
    \ rely on sight."
...
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one creature. Hit: 10\
    ...
    \ attaches to the target's head, and the target is [blinded](Misc%20Files/CLI/rules/conditions.md#Blinded)\
...
- "desc": "Each creature within 60 feet of the cloaker that can hear its moan and\
    ...
    \ [frightened](Misc%20Files/CLI/rules/conditions.md#Frightened) until the end\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/aberration/token/cloaker.webp"
```
^statblock
