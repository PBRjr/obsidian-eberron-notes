...
aliases: ["Gray Slaad"]
---
# [Gray Slaad](Misc Files\CLI\compendium\bestiary\aberration/gray-slaad.md)
...
- "desc": "The slaad's innate spellcasting ability is Charisma (spell save DC 14).\
    ...
    \ only)\n\n2/day each: [fear](Misc%20Files/CLI/compendium/spells/fear-xphb.md),\
    \ [fly](Misc%20Files/CLI/compendium/spells/fly-xphb.md), [fireball](Misc%20Files/CLI/compendium/spells/fireball-xphb.md),\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/aberration/token/gray-slaad.webp"
```
^statblock
