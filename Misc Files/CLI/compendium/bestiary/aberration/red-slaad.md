...
aliases: ["Red Slaad"]
---
# [Red Slaad](Misc Files\CLI\compendium\bestiary\aberration/red-slaad.md)
...
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one target. Hit: 7 (1d8\
    ...
    \ tadpole](Misc%20Files/CLI/compendium/bestiary/aberration/slaad-tadpole-xmm.md).\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/aberration/token/red-slaad.webp"
```
^statblock