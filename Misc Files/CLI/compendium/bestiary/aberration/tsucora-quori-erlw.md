...
---
# [Tsucora Quori](Misc Files\CLI\compendium\bestiary\aberration/tsucora-quori-erlw.md)
...
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one target. Hit: 8 (1d10\
    \ + 3) bludgeoning damage. The target is [grappled](Misc%20Files/CLI/rules/conditions.md#Grappled)\
...
"source":
- "ERLW"
"image": "Misc%20Files/CLI/compendium/bestiary/aberration/token/tsucora-quori-erlw.webp"
```
^statblock