...
aliases: ["Blue Slaad"]
---
# [Blue Slaad](Misc Files\CLI\compendium\bestiary\aberration/blue-slaad.md)
...
- "desc": "Melee Weapon Attack: +8 to hit, reach 5 ft., one target. Hit: 12\
    ...
    \ slaad](Misc%20Files/CLI/compendium/bestiary/aberration/red-slaad.md) or, if\
    \ it has the ability to cast spells of 3rd level or higher, a [green slaad](Misc%20Files/CLI/compendium/bestiary/aberration/green-slaad.md).\
    \ Only a [wish](Misc%20Files/CLI/compendium/spells/wish-xphb.md) spell can reverse\
    \ the transformation."
  "name": "Claw"
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/aberration/token/blue-slaad.webp"
```
^statblock