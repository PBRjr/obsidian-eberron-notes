...
---
# [Gibbering Mouther](Misc Files\CLI\compendium\bestiary\aberration/gibbering-mouther.md)
*Source: Monster Manual p. 157, Eberron: Rising from the Last War. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
When a gibbering mouther senses prey, its mouths begin to murmur and chatter, each with a different voice: deep or shrill, wailing or ululating, crying out in agony or ecstasy. This cacophonous gibbering overcomes the senses of any creature that hears it, causing most to flee in terror. Others are overcome with madness or stand [paralyzed](Misc%20Files/CLI/rules/conditions.md#Paralyzed), fixated on the horrific creature as it oozes forward to consume them.
...
- "desc": "The mouther babbles incoherently while it can see any creature and isn't\
    \ [incapacitated](Misc%20Files/CLI/rules/conditions.md#Incapacitated). Each creature\
...
- "desc": "Melee Weapon Attack: +2 to hit, reach 5 ft., one creature. Hit: 17\
    ...
    \ on a DC 10 Strength saving throw or be knocked [prone](Misc%20Files/CLI/rules/conditions.md#Prone).\
...
- "desc": "The mouther spits a chemical glob at a point it can see within 15 feet\
    ...
    \ be [blinded](Misc%20Files/CLI/rules/conditions.md#Blinded) until the end of\
    \ the mouther's next turn."
  "name": "Blinding Spittle (Recharge 5-6)"
"source":
- "MM"
- "ERLW"
"image": "Misc%20Files/CLI/compendium/bestiary/aberration/token/gibbering-mouther.webp"
```
^statblock
