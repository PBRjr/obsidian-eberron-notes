...
aliases: ["Spectator"]
---
# [Spectator](Misc Files\CLI\compendium\bestiary\aberration/spectator.md)
...
- "desc": "The spectator shoots up to two of the following magical eye rays at one\
    ...
    \ must succeed on a DC 13 Constitution saving throw or be [paralyzed](Misc%20Files/CLI/rules/conditions.md#Paralyzed)\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/aberration/token/spectator.webp"
```
^statblock
