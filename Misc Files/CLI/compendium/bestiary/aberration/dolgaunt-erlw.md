...
aliases: ["Dolgaunt"]
---
# [Dolgaunt](Misc Files\CLI\compendium\bestiary\aberration/dolgaunt-erlw.md)
...
- "desc": "If the dolgaunt is subjected to an effect that allows it to make a Dexterity\
    ...
    \ use this trait if it's [incapacitated](Misc%20Files/CLI/rules/conditions.md#Incapacitated)."
  "name": "Evasion"
...
- "desc": "Melee Weapon Attack: +6 to hit, reach 15 ft., one target. Hit: 7\
    \ (1d6 + 4) bludgeoning damage. The target is [grappled](Misc%20Files/CLI/rules/conditions.md#Grappled)\
...
"source":
- "ERLW"
"image": "Misc%20Files/CLI/compendium/bestiary/aberration/token/dolgaunt-erlw.webp"
```
^statblock