...
---
# [Otherworldly Steed](Misc Files\CLI\compendium\bestiary/otherworldly-steed-xphb.md)
...
- "desc": "Wisdom Saving Throw: DC equals your spell save DC, one creature within\
    \ 60 feet the steed can see. Failure: The target has the [Frightened](Misc%20Files/CLI/rules/conditions.md#Frightened)\
...
"source":
- "XPHB"
"image": "Misc%20Files/CLI/compendium/bestiary/token/otherworldly-steed-xphb.webp"
```
^statblock