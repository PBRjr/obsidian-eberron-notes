...
---
# [Rak Tulkhesh](Misc Files\CLI\compendium\bestiary\npc/rak-tulkhesh-erlw.md)
...
- "desc": "Rak Tulkhesh makes one weapon attack."
  "name": "Attack"
- "desc": "Rak Tulkhesh casts [dispel magic](Misc%20Files/CLI/compendium/spells/dispel-magic-xphb.md)."
...
"source":
- "ERLW"
"image": "Misc%20Files/CLI/compendium/bestiary/npc/token/rak-tulkhesh-erlw.webp"
```
^statblock