...
---
# [Corrin Delmaco](Misc Files\CLI\compendium\bestiary\npc/corrin-delmaco-erlw.md)
...
- "desc": "Corrin deals an extra 7 (2d6) damage when it hits a target with a weapon\
    ...
    \ feet of an ally of Corrin that isn't [incapacitated](Misc%20Files/CLI/rules/conditions.md#Incapacitated)\
...
"source":
- "ERLW"
"image": "Misc%20Files/CLI/compendium/bestiary/npc/token/corrin-delmaco-erlw.webp"
```
^statblock