...
aliases: ["Stone Giant"]
---
# [Stone Giant](Misc Files\CLI\compendium\bestiary\giant/stone-giant.md)
...
"cr": "7"
"traits":
- "desc": "The giant has advantage on Dexterity ([Stealth](Misc%20Files/CLI/rules/skills.md#Stealth))\
...
- "desc": "Ranged Weapon Attack: +9 to hit, range 60/240 ft., one target. Hit:\
    ...
    \ on a DC 17 Strength saving throw or be knocked [prone](Misc%20Files/CLI/rules/conditions.md#Prone)."
  "name": "Rock"
"reactions":
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/giant/token/stone-giant.webp"
```
^statblock
