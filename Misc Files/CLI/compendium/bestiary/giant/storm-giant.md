...
aliases: ["Storm Giant"]
---
# [Storm Giant](Misc Files\CLI\compendium\bestiary\giant/storm-giant.md)
...
- "desc": "The giant's innate spellcasting ability is Charisma (spell save DC 17).\
    ...
    \ [feather fall](Misc%20Files/CLI/compendium/spells/feather-fall-xphb.md), [levitate](Misc%20Files/CLI/compendium/spells/levitate-xphb.md),\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/giant/token/storm-giant.webp"
```
^statblock
