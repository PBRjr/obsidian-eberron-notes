...
aliases: ["Cloud Giant"]
---
# [Cloud Giant](Misc Files\CLI\compendium\bestiary\giant/cloud-giant.md)
...
- "desc": "The giant's innate spellcasting ability is Charisma. It can innately cast\
    ...
    \ magic](Misc%20Files/CLI/compendium/spells/detect-magic-xphb.md), [fog cloud](Misc%20Files/CLI/compendium/spells/fog-cloud-xphb.md),\
    ...
    \ [fly](Misc%20Files/CLI/compendium/spells/fly-xphb.md), [misty step](Misc%20Files/CLI/compendium/spells/misty-step-xphb.md),\
    \ [telekinesis](Misc%20Files/CLI/compendium/spells/telekinesis-xphb.md)"
  "name": "Innate Spellcasting"
- "desc": "The giant has advantage on Wisdom ([Perception](Misc%20Files/CLI/rules/skills.md#Perception))\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/giant/token/cloud-giant.webp"
```
^statblock
