...
aliases: ["Werewolf"]
---
# [Werewolf](Misc Files\CLI\compendium\bestiary\humanoid/werewolf.md)
*Source: Monster Manual p. 211, Eberron: Rising from the Last War. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*  
...
- "desc": "The werewolf can use its action to polymorph into a wolf-humanoid hybrid\
  ...
  "name": "Shapechanger"
- "desc": "The werewolf has advantage on Wisdom ([Perception](Misc%20Files/CLI/rules/skills.md#Perception))\
...
- "MM"
- "ERLW"
"image": "Misc%20Files/CLI/compendium/bestiary/humanoid/token/werewolf.webp"
```
^statblock
