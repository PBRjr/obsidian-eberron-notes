...
aliases: ["Werebear"]
---
# [Werebear](Misc Files\CLI\compendium\bestiary\humanoid/werebear.md)
...
- "desc": "The werebear can use its action to polymorph into a Large bear-humanoid\
    ...
    \ it dies."
  "name": "Shapechanger"
- "desc": "The werebear has advantage on Wisdom ([Perception](Misc%20Files/CLI/rules/skills.md#Perception))\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/humanoid/token/werebear.webp"
```
^statblock
