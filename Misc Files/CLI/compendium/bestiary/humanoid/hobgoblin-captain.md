...
---
# [Hobgoblin Captain](Misc Files\CLI\compendium\bestiary\humanoid/hobgoblin-captain.md)
...
- "desc": "Once per turn, the hobgoblin can deal an extra 10 (3d6) damage to a creature\
    ...
    \ the hobgoblin that isn't [incapacitated](Misc%20Files/CLI/rules/conditions.md#Incapacitated)."
...
- "desc": "For 1 minute, the hobgoblin can utter a special command or warning whenever\
    ...
    \ die at a time. This effect ends if the hobgoblin is [incapacitated](Misc%20Files/CLI/rules/conditions.md#Incapacitated)."
  "name": "Leadership (Recharges after a Short or Long Rest)"
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/humanoid/token/hobgoblin-captain.webp"
```
^statblock
