...
---
# [Githyanki Warrior](Misc Files\CLI\compendium\bestiary\humanoid/githyanki-warrior.md)
...
"ac": !!int "17"
"ac_class": "[half plate armor](Misc%20Files/CLI/compendium/items/half-plate-armor-xphb.md)"
"hp": !!int "49"
"hit_dice": "9d8 + 9"
"stats":
- !!int "15"
...
- "desc": "The githyanki's innate spellcasting ability is Intelligence. It can innately\
    ...
    \ (the hand is invisible)\n\n3/day each: [jump](Misc%20Files/CLI/compendium/spells/jump-xphb.md),\
    \ [misty step](Misc%20Files/CLI/compendium/spells/misty-step-xphb.md), [nondetection](Misc%20Files/CLI/compendium/spells/nondetection-xphb.md)\
    \ (self only)"
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/humanoid/token/githyanki-warrior.webp"
```
^statblock