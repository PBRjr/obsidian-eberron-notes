...
---
# [Kuo-toa Whip](Misc Files\CLI\compendium\bestiary\humanoid/kuo-toa-whip.md)
...
- "desc": "The kuo-toa is a 2nd-level spellcaster. Its spellcasting ability is Wisdom\
    ...
    \ level (3 slots): [bane](Misc%20Files/CLI/compendium/spells/bane-xphb.md),\
...
- "desc": "Melee Weapon Attack: +4 to hit, reach 10 ft., one target. Hit: 5\
    ...
    \ it is [grappled](Misc%20Files/CLI/rules/conditions.md#Grappled) (escape DC 14).\
    \ Until this grapple ends, the kuo-toa can't use its pincer staff on another target."
  "name": "Pincer Staff"
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/humanoid/token/kuo-toa-whip.webp"
```
^statblock
