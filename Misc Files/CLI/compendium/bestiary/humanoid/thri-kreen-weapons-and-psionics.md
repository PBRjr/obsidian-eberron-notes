...
---
# [Thri-kreen (Weapons and Psionics)](Misc Files\CLI\compendium\bestiary\humanoid/thri-kreen-weapons-and-psionics.md)
...
- "desc": "The thri-kreen's innate spellcasting ability is Wisdom. The thri-kreen\
    ...
    \ is [invisible](Misc%20Files/CLI/rules/conditions.md#Invisible))\n\n1/day:\
    \ [invisibility](Misc%20Files/CLI/compendium/spells/invisibility-xphb.md) (self\
    \ only)\n\n2/day each: [blur](Misc%20Files/CLI/compendium/spells/blur-xphb.md),\
...
- "desc": "The thri-kreen can change the color of its carapace to match the color\
    ...
    \ ([Stealth](Misc%20Files/CLI/rules/skills.md#Stealth)) checks made to hide."
...
- "desc": "Melee Weapon Attack: +3 to hit, reach 5 ft., one creature. Hit: 4\
    ...
    \ for 1 minute. If the saving throw fails by 5 or more, the target is also [paralyzed](Misc%20Files/CLI/rules/conditions.md#Paralyzed)\
    \ while [poisoned](Misc%20Files/CLI/rules/conditions.md#Poisoned) in this way.\
    \ The [poisoned](Misc%20Files/CLI/rules/conditions.md#Poisoned) target can repeat\
