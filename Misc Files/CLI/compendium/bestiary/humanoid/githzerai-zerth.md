...
---
# [Githzerai Zerth](Misc Files\CLI\compendium\bestiary\humanoid/githzerai-zerth.md)
...
Githzerai revere Zerthimon, the founder of their race. Although Gith won their people's freedom, Zerthimon saw her as unfit to lead. He believed that her warmongering would soon make her a tyrant no better than the [mind flayers](Misc%20Files/CLI/compendium/bestiary/aberration/mind-flayer.md).
...
- "desc": "The githzerai's innate spellcasting ability is Wisdom. It can innately\
    ...
    \ (the hand is invisible)\n\n1/day each: [phantasmal killer](Misc%20Files/CLI/compendium/spells/phantasmal-killer-xphb.md),\
    \ [plane shift](Misc%20Files/CLI/compendium/spells/plane-shift-xphb.md)\n\n3/day\
    \ each: [feather fall](Misc%20Files/CLI/compendium/spells/feather-fall-xphb.md),\
    \ [jump](Misc%20Files/CLI/compendium/spells/jump-xphb.md), [see invisibility](Misc%20Files/CLI/compendium/spells/see-invisibility-xphb.md),\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/humanoid/token/githzerai-zerth.webp"
```
^statblock