...
aliases: ["Goblin"]
---
# [Goblin](Misc Files\CLI\compendium\bestiary\humanoid/goblin.md)
*Source: Monster Manual p. 166, Eberron: Rising from the Last War. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*  
...
- "MM"
- "ERLW"
"image": "Misc%20Files/CLI/compendium/bestiary/humanoid/token/goblin.webp"
```
^statblock
