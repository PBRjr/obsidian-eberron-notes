...
aliases: ["Kuo-toa"]
---
# [Kuo-toa](Misc Files\CLI\compendium\bestiary\humanoid/kuo-toa.md)
...
- "desc": "Ranged Weapon Attack: +3 to hit, range 5/15 ft., one Large or smaller\
    \ creature. Hit: The target is [restrained](Misc%20Files/CLI/rules/conditions.md#Restrained).\
...
- "desc": "When a creature misses the kuo-toa with a melee weapon attack, the kuo-toa\
    ...
    \ [grappled](Misc%20Files/CLI/rules/conditions.md#Grappled) while the weapon is\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/humanoid/token/kuo-toa.webp"
```
^statblock
