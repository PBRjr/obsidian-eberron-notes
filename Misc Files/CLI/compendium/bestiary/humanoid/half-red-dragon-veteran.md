...
---
# [Half-Red Dragon Veteran](Misc Files\CLI\compendium\bestiary\humanoid/half-red-dragon-veteran.md)
...
The half-dragon gains [blindsight](Misc%20Files/CLI/rules/senses.md#Blindsight) with a radius of 10 feet and [darkvision](Misc%20Files/CLI/rules/senses.md#Darkvision) with a radius of 60 feet.

### Resistances

The half-dragon gains resistance to a type of damage based on its color.

![Resistances](Misc%20Files/CLI/compendium/tables/resistances.md)
...
![New Action: Breath Weapon](Misc%20Files/CLI/compendium/tables/new-action-breath-weapon.md)

### Sample Half-Dragon

Here the half-dragon template has been applied to a human [veteran](Misc%20Files/CLI/compendium/bestiary/humanoid/veteran.md) to create a half-red dragon veteran. [Splint armor](Misc%20Files/CLI/compendium/items/splint-armor-xphb.md) has been replaced with [plate](Misc%20Files/CLI/compendium/items/plate-armor-xphb.md).
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/humanoid/token/half-red-dragon-veteran.webp"
```
^statblock