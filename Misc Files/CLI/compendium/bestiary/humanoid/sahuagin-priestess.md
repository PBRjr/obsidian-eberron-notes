...
---
# [Sahuagin Priestess](Misc Files\CLI\compendium\bestiary\humanoid/sahuagin-priestess.md)
...
- "desc": "The sahuagin is a 6th-level spellcaster. Her spellcasting ability is Wisdom\
    ...
    \ [detect magic](Misc%20Files/CLI/compendium/spells/detect-magic-xphb.md), [guiding\
    \ bolt](Misc%20Files/CLI/compendium/spells/guiding-bolt-xphb.md)\n\n2nd level\
    \ (3 slots): [hold person](Misc%20Files/CLI/compendium/spells/hold-person-xphb.md),\
    \ [spiritual weapon](Misc%20Files/CLI/compendium/spells/spiritual-weapon-xphb.md)\
    \ (trident)\n\n3rd level (3 slots): [mass healing word](Misc%20Files/CLI/compendium/spells/mass-healing-word-xphb.md),\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/humanoid/token/sahuagin-priestess.webp"
```
^statblock
