...
---
# [Orc Eye of Gruumsh](Misc Files\CLI\compendium\bestiary\humanoid/orc-eye-of-gruumsh.md)
...
- "desc": "The orc is a 3rd-level spellcaster. Its spellcasting ability is Wisdom\
    ...
    \ [resistance](Misc%20Files/CLI/compendium/spells/resistance-xphb.md), [thaumaturgy](Misc%20Files/CLI/compendium/spells/thaumaturgy-xphb.md)\n\
    \n1st level (4 slots): [bless](Misc%20Files/CLI/compendium/spells/bless-xphb.md),\
    \ [command](Misc%20Files/CLI/compendium/spells/command-xphb.md)\n\n2nd level\
    \ (2 slots): [augury](Misc%20Files/CLI/compendium/spells/augury-xphb.md), [spiritual\
    \ weapon](Misc%20Files/CLI/compendium/spells/spiritual-weapon-xphb.md) (spear)"
  "name": "Spellcasting"
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/humanoid/token/orc-eye-of-gruumsh.webp"
```
^statblock
