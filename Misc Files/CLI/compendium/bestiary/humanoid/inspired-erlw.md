...
aliases: ["Inspired"]
---
# [Inspired](Misc Files\CLI\compendium\bestiary\humanoid/inspired-erlw.md)
...
- "desc": "The Inspired's spellcasting ability is Intelligence (spell save DC 13).\
    ...
    \ [hex](Misc%20Files/CLI/compendium/spells/hex-xphb.md), [hold person](Misc%20Files/CLI/compendium/spells/hold-person-xphb.md),\
...
"source":
- "ERLW"
"image": "Misc%20Files/CLI/compendium/bestiary/humanoid/token/inspired-erlw.webp"
```
^statblock