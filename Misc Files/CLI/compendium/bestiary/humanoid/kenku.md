...
aliases: ["Kenku"]
---
# [Kenku](Misc Files\CLI\compendium\bestiary\humanoid/kenku.md)
...
- "desc": "In the first round of a combat, the kenku has advantage on attack rolls\
    \ against any creature it [surprised](Misc%20Files/CLI/rules/conditions.md#Surprised)."
  "name": "Ambusher"
...
- "MM"
- "ERLW"
"image": "Misc%20Files/CLI/compendium/bestiary/humanoid/token/kenku.webp"
```
^statblock
