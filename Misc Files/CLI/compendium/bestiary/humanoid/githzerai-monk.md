...
---
# [Githzerai Monk](Misc Files\CLI\compendium\bestiary\humanoid/githzerai-monk.md)
...
- "desc": "The githzerai's innate spellcasting ability is Wisdom. It can innately\
    ...
    \ (the hand is invisible)\n\n3/day each: [feather fall](Misc%20Files/CLI/compendium/spells/feather-fall-xphb.md),\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/humanoid/token/githzerai-monk.webp"
```
^statblock