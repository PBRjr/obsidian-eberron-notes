...
aliases: ["Bullywug"]
---
# [Bullywug](Misc Files\CLI\compendium\bestiary\humanoid/bullywug.md)
...
- "desc": "The bullywug has advantage on Dexterity ([Stealth](Misc%20Files/CLI/rules/skills.md#Stealth))\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/humanoid/token/bullywug.webp"
```
^statblock
