...
aliases: ["Orc"]
---
# [Orc](Misc Files\CLI\compendium\bestiary\humanoid/orc.md)
*Source: Monster Manual p. 246, Eberron: Rising from the Last War. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*  
...
- "MM"
- "ERLW"
"image": "Misc%20Files/CLI/compendium/bestiary/humanoid/token/orc.webp"
```
^statblock
