...
aliases: ["Wererat"]
---
# [Wererat](Misc Files\CLI\compendium\bestiary\humanoid/wererat.md)
...
- "desc": "The wererat can use its action to polymorph into a rat-humanoid hybrid\
  ...
  "name": "Shapechanger"
- "desc": "The wererat has advantage on Wisdom ([Perception](Misc%20Files/CLI/rules/skills.md#Perception))\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/humanoid/token/wererat.webp"
```
^statblock
