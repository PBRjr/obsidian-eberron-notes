...
aliases: ["Aarakocra"]
---
# [Aarakocra](Misc Files\CLI\compendium\bestiary\humanoid/aarakocra.md)
...
- "desc": "Five aarakocra within 30 feet of each other can magically summon an [air\
    \ elemental](Misc%20Files/CLI/compendium/bestiary/elemental/air-elemental.md).\
    \ Each of the five must use its action and movement on three consecutive turns\
    \ to perform an aerial dance and must maintain [concentration](Misc%20Files/CLI/rules/conditions.md#Concentration)\
    \ while doing so (as if [concentrating](Misc%20Files/CLI/rules/conditions.md#Concentration)\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/humanoid/token/aarakocra.webp"
```
^statblock
