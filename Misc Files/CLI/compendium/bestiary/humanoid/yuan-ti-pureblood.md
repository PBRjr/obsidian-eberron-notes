...
---
# [Yuan-ti Pureblood](Misc Files\CLI\compendium\bestiary\humanoid/yuan-ti-pureblood.md)
...
- "desc": "The yuan-ti's spellcasting ability is Charisma (spell save DC 12). The\
    ...
    \ (snakes only)\n\n3/day each: [poison spray](Misc%20Files/CLI/compendium/spells/poison-spray-xphb.md),\
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/humanoid/token/yuan-ti-pureblood.webp"
```
^statblock
