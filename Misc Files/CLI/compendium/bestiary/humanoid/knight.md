...
aliases: ["Knight"]
---
# [Knight](Misc Files\CLI\compendium\bestiary\humanoid/knight.md)
...
"cr": "3"
"traits":
- "desc": "The knight has advantage on saving throws against being [frightened](Misc%20Files/CLI/rules/conditions.md#Frightened)."
  "name": "Brave"
"actions":
...
- "desc": "For 1 minute, the knight can utter a special command or warning whenever\
    ...
    \ at a time. This effect ends if the knight is [incapacitated](Misc%20Files/CLI/rules/conditions.md#Incapacitated)."
...
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/humanoid/token/knight.webp"
```
^statblock
