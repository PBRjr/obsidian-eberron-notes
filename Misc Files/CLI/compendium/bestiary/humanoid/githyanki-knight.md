...
---
# [Githyanki Knight](Misc Files\CLI\compendium\bestiary\humanoid/githyanki-knight.md)
...
These silver swords channel the force of the wielder's will, dealing psychic as well as physical damage. A githyanki can't become a knight until it masters the singular discipline needed to will such a blade into existence. A silver sword is equivalent to a [greatsword](Misc%20Files/CLI/compendium/items/greatsword-xphb.md), and takes on the properties of a [+3 greatsword](Misc%20Files/CLI/compendium/items/3-weapon-xdmg.md) in the hands of its creator.
...
The warlike githyanki and the contemplative githzerai are a sundered people-two cultures that utterly despise one another. Before there were githyanki or githzerai, these creatures were a single race enslaved by the [mind flayers](Misc%20Files/CLI/compendium/bestiary/aberration/mind-flayer.md). Although they attempted to overthrow their masters many times, their rebellions were repeatedly crushed until a great leader named Gith arose.
...
Whether these tall, gaunt creatures were peaceful or savage, cultured or primitive before the [mind flayers](Misc%20Files/CLI/compendium/bestiary/aberration/mind-flayer.md) enslaved and changed them, none can say. Not even the original name of their race remains from that distant time.
...
- "desc": "The githyanki's innate spellcasting ability is Intelligence (spell save\
    ...
    \ (the hand is invisible)\n\n1/day each: [plane shift](Misc%20Files/CLI/compendium/spells/plane-shift-xphb.md),\
    \ [telekinesis](Misc%20Files/CLI/compendium/spells/telekinesis-xphb.md)\n\n3/day\
    \ each: [jump](Misc%20Files/CLI/compendium/spells/jump-xphb.md), [misty step](Misc%20Files/CLI/compendium/spells/misty-step-xphb.md),\
    \ [nondetection](Misc%20Files/CLI/compendium/spells/nondetection-xphb.md) (self\
    \ only), [tongues](Misc%20Files/CLI/compendium/spells/tongues-xphb.md)"
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one target. Hit: 13\
    ...
    \ the [astral projection](Misc%20Files/CLI/compendium/spells/astral-projection-xphb.md)\
    \ spell), the githyanki can cut the silvery cord that tethers the target to its\
    \ material body, instead of dealing damage."
  "name": "Silver Greatsword"
"source":
- "MM"
"image": "Misc%20Files/CLI/compendium/bestiary/humanoid/token/githyanki-knight.webp"
```
^statblock