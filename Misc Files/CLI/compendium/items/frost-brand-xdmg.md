...
![](Misc%20Files/CLI/compendium/items/img/frost-brand.webp#right)


When you hit with an attack roll using this magic weapon, the target takes an extra `1d6` Cold damage. In addition, while you hold the weapon, you have [Resistance](Misc%20Files/CLI/rules/variant-rules/resistance-xphb.md) to Fire damage.

In freezing temperatures, the weapon sheds [Bright Light](Misc%20Files/CLI/rules/variant-rules/bright-light-xphb.md) in a 10-foot radius and [Dim Light](Misc%20Files/CLI/rules/variant-rules/dim-light-xphb.md) for an additional 10 feet.
