...
![](Misc%20Files/CLI/compendium/items/img/efreeti-bottle.webp#right)


When you take a [Magic](Misc%20Files/CLI/rules/actions.md#Magic) action to remove the stopper of this painted brass bottle, a cloud of thick smoke flows out of it. At the end of your turn, the smoke disappears with a flash of harmless fire, and an Efreeti appears in an unoccupied space within 30 feet of you.
...
| 10 | The efreeti understands your languages and can cast [Wish](Misc%20Files/CLI/compendium/spells/wish-xphb.md) once for you. It disappears when it grants the wish or after 1 hour, and the bottle loses its magic. |
^1-effect
