...
If you attack with a double-bladed scimitar as part of the [Attack](Misc%20Files/CLI/rules/actions.md#Attack) action on your turn, you can use a bonus action immediately after to make a melee attack with it. This attack deals `1d4` slashing damage on a hit, instead of `2d4`.
