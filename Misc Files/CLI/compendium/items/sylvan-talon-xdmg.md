...
![](Misc%20Files/CLI/compendium/items/img/sylvan-talon.webp#right)
...
As a [Magic](Misc%20Files/CLI/rules/actions.md#Magic) action, you can use the weapon to cast [Message](Misc%20Files/CLI/compendium/spells/message-xphb.md). Once this property is used, it can't be used again until the next dawn.
