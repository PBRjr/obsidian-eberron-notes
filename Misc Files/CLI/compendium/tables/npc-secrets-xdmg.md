...
| 4 | The NPC is under a magical compulsion (perhaps a [Geas](Misc%20Files/CLI/compendium/spells/geas-xphb.md) spell or some kind of curse) to behave in a certain way. |
