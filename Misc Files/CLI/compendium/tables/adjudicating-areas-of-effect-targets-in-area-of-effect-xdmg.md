...
*Use this column for [Cylinders](Misc%20Files/CLI/rules/variant-rules/cylinder-area-of-effect-xphb.md), [Emanations](Misc%20Files/CLI/rules/variant-rules/emanation-area-of-effect-xphb.md) (using the size of the Emanation rather than its radius), and [Spheres](Misc%20Files/CLI/rules/variant-rules/sphere-area-of-effect-xphb.md).