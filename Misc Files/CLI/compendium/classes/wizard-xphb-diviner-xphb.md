...
Glimpses of the future begin to press on your awareness. Whenever you finish a [Long Rest](Misc%20Files/CLI/rules/variant-rules/long-rest-xphb.md), roll two d20s and record the numbers rolled. You can replace any [D20 Test](Misc%20Files/CLI/rules/variant-rules/d20-test-xphb.md) made by you or a creature that you can see with one of these foretelling rolls. You must choose to do so before the roll, and you can replace a roll in this way only once per turn.

Each foretelling roll can be used only once. When you finish a [Long Rest](Misc%20Files/CLI/rules/variant-rules/long-rest-xphb.md), you lose any unused foretelling rolls.
...
You can increase your powers of perception. As a [Bonus Action](Misc%20Files/CLI/rules/variant-rules/bonus-action-xphb.md), choose one of the following benefits, which lasts until you start a [Short](Misc%20Files/CLI/rules/variant-rules/short-rest-xphb.md) or [Long Rest](Misc%20Files/CLI/rules/variant-rules/long-rest-xphb.md). You can't use this feature again until you finish a [Short](Misc%20Files/CLI/rules/variant-rules/short-rest-xphb.md) or [Long Rest](Misc%20Files/CLI/rules/variant-rules/long-rest-xphb.md).

#### Darkvision

You gain [Darkvision](Misc%20Files/CLI/rules/senses.md#Darkvision) with a range of 120 feet.
...
You can cast [See Invisibility](Misc%20Files/CLI/compendium/spells/see-invisibility-xphb.md) without expending a spell slot.
