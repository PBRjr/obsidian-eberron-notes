...
You have [Advantage](Misc%20Files/CLI/rules/variant-rules/advantage-xphb.md) on [Initiative](Misc%20Files/CLI/rules/variant-rules/initiative-xphb.md) rolls.

#### Surprising Strikes

During the first round of each combat, you have [Advantage](Misc%20Files/CLI/rules/variant-rules/advantage-xphb.md) on attack rolls against any creature that hasn't taken a turn. If your Sneak Attack hits any target during that round, the target takes extra damage of the weapon's type equal to your Rogue level.

### Assassin's Tools (Level 3)

You gain a [Disguise Kit](Misc%20Files/CLI/compendium/items/disguise-kit-xphb.md) and a [Poisoner's Kit](Misc%20Files/CLI/compendium/items/poisoners-kit-xphb.md), and you have proficiency with them.
...
Your [Speed](Misc%20Files/CLI/rules/variant-rules/speed-xphb.md) isn't reduced to 0 by using Steady Aim.

### Envenom Weapons (Level 13)

When you use the Poison option of your Cunning Strike, the target also takes `2d6` Poison damage whenever it fails the saving throw. This damage ignores [Resistance](Misc%20Files/CLI/rules/variant-rules/resistance-xphb.md) to Poison damage.

### Death Strike (Level 17)

When you hit with your Sneak Attack on the first round of a combat, the target must succeed on a Constitution saving throw (DC 8 plus your Dexterity modifier and [Proficiency Bonus](Misc%20Files/CLI/rules/variant-rules/proficiency-xphb.md)), or the attack's damage is doubled against the target.