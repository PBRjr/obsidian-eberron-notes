...
The first time you do so, you suffer no adverse effect. If you use this feature again before you finish a [Long Rest](Misc%20Files/CLI/rules/variant-rules/long-rest-xphb.md), you take `2d12` Necrotic damage for each level of the spell slot immediately after you cast it. This damage ignores [Resistance](Misc%20Files/CLI/rules/variant-rules/resistance-xphb.md) and [Immunity](Misc%20Files/CLI/rules/variant-rules/immunity-xphb.md).

Each time you use this feature again before finishing a [Long Rest](Misc%20Files/CLI/rules/variant-rules/long-rest-xphb.md), the Necrotic damage per spell level increases by `1d12`.