...
- **Craft.** Smith's Tools. The facility's hirelings craft anything that can be made with [Smith's Tools](Misc%20Files/CLI/compendium/items/smiths-tools-xphb.md), using the rules in the "Player's Handbook".  
