...
![](Misc%20Files/CLI/compendium/races/img/warforged.webp#right)
...
- You have advantage on saving throws against being [poisoned](Misc%20Files/CLI/rules/conditions.md#Poisoned), and you have resistance to poison damage.  
...
When you take a long rest, you must spend at least six hours in an inactive, motionless state, rather than sleeping. In this state, you appear inert, but it doesn't render you [unconscious](Misc%20Files/CLI/rules/conditions.md#Unconscious), and you can see and hear as normal.
...
Although they were manufactured, warforged are living humanoids. Resting, healing magic, and the [Medicine](Misc%20Files/CLI/rules/skills.md#Medicine) skill all provide the same benefits to warforged that they do to other humanoids.
...
![](Misc%20Files/CLI/compendium/races/img/warforged-001.webp#center)