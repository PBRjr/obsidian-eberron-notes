...
![](Misc%20Files/CLI/compendium/races/img/halfling.webp#right)
...
You have [Advantage](Misc%20Files/CLI/rules/variant-rules/advantage-xphb.md) on saving throws you make to avoid or end the [Frightened](Misc%20Files/CLI/rules/conditions.md#Frightened) condition.
...
When you roll a 1 on the `d20` of a [D20 Test](Misc%20Files/CLI/rules/variant-rules/d20-test-xphb.md), you can reroll the die, and you must use the new roll.

### Naturally Stealthy

You can take the [Hide](Misc%20Files/CLI/rules/actions.md#Hide) action even when you are obscured only by a creature that is at least one size larger than you.
