...
![The Lady of Pain appears w...](Misc%20Files/CLI/compendium/books/dungeon-masters-guide-2024/img/084-06-001-the-lady-of-pain.webp#center "The Lady of Pain appears without warning in the bustling streets of Sigil, and the city's residents get out of her way")
...
![Outer Planes](Misc%20Files/CLI/compendium/tables/outer-planes-xdmg.md)
...
![](Misc%20Files/CLI/compendium/books/dungeon-masters-guide-2024/img/085-06-002-the-multiverse.webp#center)
...
A number of spells allow direct or indirect access to different planes of existence. [Gate](Misc%20Files/CLI/compendium/spells/gate-xphb.md) and [Plane Shift](Misc%20Files/CLI/compendium/spells/plane-shift-xphb.md) can directly transport adventurers to any other plane, with different degrees of precision. [Etherealness](Misc%20Files/CLI/compendium/spells/etherealness-xphb.md) allows adventurers to enter the Ethereal Plane. And [Astral Projection](Misc%20Files/CLI/compendium/spells/astral-projection-xphb.md) lets adventurers project themselves into the Astral Plane and from there travel to the Outer Planes.
...
![A portal to the Beastlands...](Misc%20Files/CLI/compendium/books/dungeon-masters-guide-2024/img/086-06-003-portal-to-the-beastlands.webp#center "A portal to the Beastlands opens amid the branches of the World Tree")
...
![Planar Adventure Situations](Misc%20Files/CLI/compendium/tables/planar-adventure-situations-xdmg.md)
...
![Layers of the Abyss](Misc%20Files/CLI/compendium/tables/layers-of-the-abyss-xdmg.md)
...
![The detritus of the Planes...](Misc%20Files/CLI/compendium/books/dungeon-masters-guide-2024/img/087-06-004-demonweb-pits.webp#center "The detritus of the Planes is tangled in the Demonweb Pits")
...
![Layers of Acheron](Misc%20Files/CLI/compendium/tables/layers-of-acheron-xdmg.md)
...
![Layers of Arborea](Misc%20Files/CLI/compendium/tables/layers-of-arborea-xdmg.md)
...
![](Misc%20Files/CLI/compendium/books/dungeon-masters-guide-2024/img/088-06-005-arcadia.webp#center)
...
![Layers of Arcadia](Misc%20Files/CLI/compendium/tables/layers-of-arcadia-xdmg.md)
...
![Astral Color Pools](Misc%20Files/CLI/compendium/tables/astral-color-pools-xdmg.md)
...
![Psychic Wind Location Effects](Misc%20Files/CLI/compendium/tables/psychic-wind-location-effects-xdmg.md)
...
![Psychic Wind Psychic Effects](Misc%20Files/CLI/compendium/tables/psychic-wind-psychic-effects-xdmg.md)
...
![Layers of Bytopia](Misc%20Files/CLI/compendium/tables/layers-of-bytopia-xdmg.md)
...
![Layers of Carceri](Misc%20Files/CLI/compendium/tables/layers-of-carceri-xdmg.md)

#### Prison Plane

![Unknown horrors are entrap...](Misc%20Files/CLI/compendium/books/dungeon-masters-guide-2024/img/090-06-007-ice-of-carceri.webp#center "Unknown horrors are entrapped in the ice of Carceri")

No one can leave Carceri easily. Magical efforts to leave the plane by any spell other than [Wish](Misc%20Files/CLI/compendium/spells/wish-xphb.md) simply fail. Portals and gates that open onto the plane become one-way only. Secret passages out of the plane exist, but they are hidden and well guarded by traps and deadly monsters. And though the River Styx flows between Carceri and its neighbors, the passage is extremely dangerous, and ferries leading out of Carceri are both rare and expensive.
...
![Aarakocra scouts return ho...](Misc%20Files/CLI/compendium/books/dungeon-masters-guide-2024/img/091-06-008-plane-of-air.webp#center "Aarakocra scouts return home to a city on the Plane of Air")
...
Built atop a tall basalt crag in the middle of a lava river is an iron-walled tavern that is most easily reached by hot-air balloon. The proprietor is a sentient [Flame Tongue (Mace)](Misc%20Files/CLI/compendium/items/flame-tongue-xdmg.md) named Torchy, who sells a fine ale and seems to have a new wielder every few months. Torchy's is a popular hangout for ballooning enthusiasts.
...
![The City of Brass is a hub...](Misc%20Files/CLI/compendium/books/dungeon-masters-guide-2024/img/092-06-009-city-of-brass.webp#center "The City of Brass is a hub for trade from across the multiverse")
...
![Layers of Elysium](Misc%20Files/CLI/compendium/tables/layers-of-elysium-xdmg.md)
...
Characters can use the [Etherealness](Misc%20Files/CLI/compendium/spells/etherealness-xphb.md) spell to enter the Border Ethereal. The [Plane Shift](Misc%20Files/CLI/compendium/spells/plane-shift-xphb.md) spell allows transport to the Border Ethereal or the Deep Ethereal, but unless the intended destination is a specific location or a teleportation circle, the point of arrival could be anywhere on the plane.
...
To reach the Deep Ethereal, one typically needs a [Plane Shift](Misc%20Files/CLI/compendium/spells/plane-shift-xphb.md) spell, a [Gate](Misc%20Files/CLI/compendium/spells/gate-xphb.md) spell, or a magical portal. Visitors to the Deep Ethereal are engulfed by roiling mist. Scattered throughout the plane are curtains of vaporous color, and passing through a curtain leads a traveler to a region of the Border Ethereal connected to a specific Inner Plane, the Material Plane, the Feywild, or the Shadowfell. The color of the curtain indicates the plane whose Border Ethereal the curtain conceals; see the Ethereal Curtains table. The curtains are also distinguishable by texture and temperature, each one reflecting something of the nature of the plane beyond.

![The Radiant Citadel is a r...](Misc%20Files/CLI/compendium/books/dungeon-masters-guide-2024/img/093-06-010-the-radiant-citadel.webp#center "The Radiant Citadel is a refuge in the Ethereal Plane, despite its proximity to a raging ether cyclone")

![Deep Ethereal; Ethereal Curtains](Misc%20Files/CLI/compendium/tables/deep-ethereal-ethereal-curtains-xdmg.md)
...
An ether cyclone is a serpentine column that spins through the plane. The cyclone appears abruptly, distorting and uprooting everything in its path and carrying the debris for miles. Travelers with a [Passive Perception](Misc%20Files/CLI/rules/variant-rules/passive-perception-xphb.md) score of 15 or higher receive 1 minute of warning: a deep thrum in the ethereal matter. Travelers who can't reach a curtain or portal leading elsewhere suffer the cyclone's effect. Roll `d20` and consult the Ether Cyclone table to determine the effect on all creatures in the vicinity.

![Ether Cyclones; Ether Cyclone](Misc%20Files/CLI/compendium/tables/ether-cyclones-ether-cyclone-xdmg.md)

#### Radiant Citadel

![](Misc%20Files/CLI/compendium/books/dungeon-masters-guide-2024/img/094-06-011-lotus.webp#center)
...
![When the Dragon's Tear com...](Misc%20Files/CLI/compendium/books/dungeon-masters-guide-2024/img/095-06-012-the-vast-gate.webp#center "When the Dragon's Tear comet appears above Firestorm Peak, the Vast Gate forms a bridge to the Far Realm")
...
Whenever a creature or group of creatures leaves the Feywild after spending at least 1 day on that plane, you can choose a time change that works best for your campaign, if any, or roll on the Feywild Time Warp table. A [Wish](Misc%20Files/CLI/compendium/spells/wish-xphb.md) spell can be used to remove the effect on up to ten creatures. Some powerful Fey have the ability to grant such wishes and might do so if the beneficiaries agree to subject themselves to a [Geas](Misc%20Files/CLI/compendium/spells/geas-xphb.md) spell and complete a quest after the *Wish* spell is cast.

![Feywild Time Warp](Misc%20Files/CLI/compendium/tables/feywild-time-warp-xdmg.md)
...
![Fey revel in the Gloaming ...](Misc%20Files/CLI/compendium/books/dungeon-masters-guide-2024/img/096-06-013-the-gloaming-court.webp#center "Fey revel in the Gloaming Court under the watchful eye of the Queen of Air and Darkness")
...
![Layers of Gehenna](Misc%20Files/CLI/compendium/tables/layers-of-gehenna-xdmg.md)
...
![With its magical marvels o...](Misc%20Files/CLI/compendium/books/dungeon-masters-guide-2024/img/097-06-014-eberron-technology.webp#center "With its magical marvels of technology, Eberron is one of countless worlds on the Material Plane")
...
The most direct method involves the use of spells such as [Teleportation Circle](Misc%20Files/CLI/compendium/spells/teleportation-circle-xphb.md) or [Teleport](Misc%20Files/CLI/compendium/spells/teleport-xphb.md), or magical portals like those described in this chapter. This magic causes the user to appear in a known teleportation circle or some other location in another world.
...
![The Seven Heavens of Mount...](Misc%20Files/CLI/compendium/books/dungeon-masters-guide-2024/img/098-06-015-mount-celestia.webp#center "The Seven Heavens of Mount Celestia beckon virtuous souls toward ever-greater heights")

![Layers of Mount Celestia](Misc%20Files/CLI/compendium/tables/layers-of-mount-celestia-xdmg.md)
...
In some locations on the Negative Plane, the intensity of the plane is so great that the negative energy folds in on itself, stabilizing into solid chunks of matter that devour light. These chunks, called voidstones, are thought to be the source of [Spheres of Annihilation](Misc%20Files/CLI/compendium/items/sphere-of-annihilation-xdmg.md) and similar magical effects. Anything that comes into contact with a voidstone is destroyed in seconds.
...
![Layers of the Nine Hells](Misc%20Files/CLI/compendium/tables/layers-of-the-nine-hells-xdmg.md)

#### Avernus

![The first of Nine Hells, A...](Misc%20Files/CLI/compendium/books/dungeon-masters-guide-2024/img/099-06-016-avernus.webp#center "The first of Nine Hells, Avernus, is an eternal battlefield in the Blood War")
...
![Asmodeus, the Lord of the ...](Misc%20Files/CLI/compendium/books/dungeon-masters-guide-2024/img/100-06-017-asmodeus.webp#center "Asmodeus, the Lord of the Nine, maintains a veneer of pleasantry while inflicting agony on imprisoned souls")
...
> -     - Lemure    
> -     - [Imp](Misc%20Files/CLI/compendium/bestiary/fiend/imp-xmm.md)    
>         - Spined devil    
>         - Bearded devil    
>         - Barbed devil    
>         - Chain devil    
...
![Gate-Towns of the Outlands](Misc%20Files/CLI/compendium/tables/gate-towns-of-the-outlands-xdmg.md)
...
![Layers of Pandemonium](Misc%20Files/CLI/compendium/tables/layers-of-pandemonium-xdmg.md)
...
![Three adventurers brave th...](Misc%20Files/CLI/compendium/books/dungeon-masters-guide-2024/img/101-06-018-winds-of-pandemonium.webp#center "Three adventurers brave the howling winds of Pandemonium in search of Howler's Crag")
...
![The Shadowfell is a realm ...](Misc%20Files/CLI/compendium/books/dungeon-masters-guide-2024/img/102-06-019-the-shadowfell.webp#center "The Shadowfell is a realm of death, despair, and dread")
...
![In the cosmopolitan street...](Misc%20Files/CLI/compendium/books/dungeon-masters-guide-2024/img/103-06-020-citizens-of-sigil.webp#center "In the cosmopolitan streets of Sigil, creatures from across the multiverse coexist in uneasy peace")
...
![Layers of Ysgard](Misc%20Files/CLI/compendium/tables/layers-of-ysgard-xdmg.md)
