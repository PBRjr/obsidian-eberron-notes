...
![](Misc%20Files/CLI/compendium/books/players-handbook-2014/img/planes-1.webp#center)
...
A number of spells allow direct or indirect access to other planes of existence. [Plane shift](Misc%20Files/CLI/compendium/spells/plane-shift-xphb.md) and [gate](Misc%20Files/CLI/compendium/spells/gate-xphb.md) can transport adventurers directly to any other plane of existence, with different degrees of precision. Etherealness allows adventurers to enter the Ethereal Plane and travel from there to any of the planes it touches—the Shadowfell, the Feywild, or the Elemental Planes. And the [astral projection](Misc%20Files/CLI/compendium/spells/astral-projection-xphb.md) spell lets adventurers project themselves into the Astral Plane and travel to the Outer Planes.
...
![Outer Planes](Misc%20Files/CLI/compendium/tables/outer-planes.md)
...
![](Misc%20Files/CLI/compendium/books/players-handbook-2014/img/planes-2.webp#center)