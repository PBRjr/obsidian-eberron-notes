...
![](Misc%20Files/CLI/compendium/books/players-handbook-2014/img/ch6.webp#center)
...
![Multiclassing Prerequisites](Misc%20Files/CLI/compendium/tables/multiclassing-prerequisites.md)
...
![Multiclassing Proficiencies](Misc%20Files/CLI/compendium/tables/multiclassing-proficiencies.md)
...
If you have more than one spellcasting class, this table might give you spell slots of a level that is higher than the spells you know or can prepare. You can use those slots, but only to cast your lower-level spells. If a lower-level spell that you cast, like [burning hands](Misc%20Files/CLI/compendium/spells/burning-hands-xphb.md), has an enhanced effect when cast using a higher-level slot, you can use the enhanced effect, even though you don't have any spells of that higher level.
...
![Spellcasting; Multiclass Spellcaster: Spell Slots per Spell Level](Misc%20Files/CLI/compendium/tables/spellcasting-multiclass-spellcaster-spell-slots-per-spell-level.md)
