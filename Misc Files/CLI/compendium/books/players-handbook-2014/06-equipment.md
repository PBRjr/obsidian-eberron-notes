...
![](Misc%20Files/CLI/compendium/books/players-handbook-2014/img/ch5.webp#center)
...
![Starting Equipment; Starting Wealth by Class](Misc%20Files/CLI/compendium/tables/starting-equipment-starting-wealth-by-class.md)
...
![](Misc%20Files/CLI/compendium/books/players-handbook-2014/img/c51.webp#center)

![Coinage; Standard Exchange Rates](Misc%20Files/CLI/compendium/tables/coinage-standard-exchange-rates.md)
...
![Armor and Shields; Armor](Misc%20Files/CLI/compendium/tables/armor-and-shields-armor.md)
...
![](Misc%20Files/CLI/compendium/books/players-handbook-2014/img/c52.webp#center)
...
If the Armor table shows "Disadvantage" in the Stealth column, the wearer has disadvantage on Dexterity ([Stealth](Misc%20Files/CLI/rules/skills.md#Stealth)) checks.
...
![Getting Into and Out of Armor; Donning and Doffing Armor](Misc%20Files/CLI/compendium/tables/getting-into-and-out-of-armor-donning-and-doffing-armor.md)
...
![Weapons](Misc%20Files/CLI/compendium/tables/weapons.md)
...
![](Misc%20Files/CLI/compendium/books/players-handbook-2014/img/c56.webp#center)
...
> [!gallery]
> ![](Misc%20Files/CLI/compendium/books/players-handbook-2014/img/c53.webp#gallery)
> ![](Misc%20Files/CLI/compendium/books/players-handbook-2014/img/c54.webp#gallery)
...
A Large or smaller creature hit by a net is [restrained](Misc%20Files/CLI/rules/conditions.md#Restrained) until it is freed. A net has no effect on creatures that are formless, or creatures that are Huge or larger. A creature can use its action to make a DC 10 Strength check, freeing itself or another creature within its reach on a success. Dealing 5 slashing damage to the net (AC 10) also frees the creature without harming it, ending the effect and destroying the net. When you use an action, bonus action, or reaction to attack with a net, you can make only one attack regardless of the number of attacks you can normally make.

![](Misc%20Files/CLI/compendium/books/players-handbook-2014/img/c55.webp#center)

## Adventuring Gear

This section describes items that have special rules or require further explanation.

![Adventuring Gear](Misc%20Files/CLI/compendium/tables/adventuring-gear.md)
...
This kit is a leather pouch containing bandages, salves, and splints. The kit has ten uses. As an action, you can expend one use of the kit to stabilize a creature that has 0 hit points, without needing to make a Wisdom ([Medicine](Misc%20Files/CLI/rules/skills.md#Medicine)) check.

![](Misc%20Files/CLI/compendium/books/players-handbook-2014/img/c57.webp#center)
...
A key is provided with the lock. Without the key, a creature proficient with [thieves' tools](Misc%20Files/CLI/compendium/items/thieves-tools-xphb.md) can pick this lock with a successful DC 15 Dexterity check. Your DM may decide that better locks are available for higher prices.
...
These metal restraints can bind a Small or Medium creature. Escaping the manacles requires a successful DC 20 Dexterity check. Breaking them requires a successful DC 20 Strength check. Each set of manacles comes with one key. Without the key, a creature proficient with [thieves' tools](Misc%20Files/CLI/compendium/items/thieves-tools-xphb.md) can pick the manacles' lock with a successful DC 15 Dexterity check. Manacles have 15 hit points.
...
![](Misc%20Files/CLI/compendium/books/players-handbook-2014/img/c58.webp#center)

![Adventuring Gear; Container Capacity](Misc%20Files/CLI/compendium/tables/adventuring-gear-container-capacity.md)
...
This set of instruments is used for navigation at sea. Proficiency with [navigator's tools](Misc%20Files/CLI/compendium/items/navigators-tools-xphb.md) lets you chart a ship's course and follow navigation charts. In addition, these tools allow you to add your proficiency bonus to any ability check you make to avoid getting lost at sea.

### Poisoner's Kit

A [poisoner's kit](Misc%20Files/CLI/compendium/items/poisoners-kit-xphb.md) includes the vials, chemicals, and other equipment necessary for the creation of poisons. Proficiency with this kit lets you add your proficiency bonus to any ability checks you make to craft or use poisons.

### Thieves' Tools

This set of tools includes a small file, a set of lock picks, a small mirror mounted on a metal handle, a set of narrow-bladed scissors, and a pair of pliers. Proficiency with these tools lets you add your proficiency bonus to any ability checks you make to disarm traps or open locks.

![](Misc%20Files/CLI/compendium/books/players-handbook-2014/img/c59.webp#center)

![Tools](Misc%20Files/CLI/compendium/tables/tools.md)
...
A [military saddle](Misc%20Files/CLI/compendium/items/military-saddle-xphb.md) braces the rider, helping you keep your seat on an active mount in battle. It gives you advantage on any check you make to remain mounted. An [exotic saddle](Misc%20Files/CLI/compendium/items/exotic-saddle-xphb.md) is required for riding any aquatic or flying mount.
...
![](Misc%20Files/CLI/compendium/books/players-handbook-2014/img/c510.webp#center)

![Mounts and Vehicles; Mounts and Other Animals](Misc%20Files/CLI/compendium/tables/mounts-and-vehicles-mounts-and-other-animals.md)

![Mounts and Vehicles; Tack, Harness, and Drawn Vehicles](Misc%20Files/CLI/compendium/tables/mounts-and-vehicles-tack-harness-and-drawn-vehicles.md)

![Mounts and Vehicles; Waterborne Vehicles](Misc%20Files/CLI/compendium/tables/mounts-and-vehicles-waterborne-vehicles.md)

![](Misc%20Files/CLI/compendium/books/players-handbook-2014/img/c511.webp#center)
...
![Trade Goods](Misc%20Files/CLI/compendium/tables/trade-goods.md)
...
![](Misc%20Files/CLI/compendium/books/players-handbook-2014/img/c512.webp#center)

![Lifestyle Expenses](Misc%20Files/CLI/compendium/tables/lifestyle-expenses.md)
...
![Food, Drink, and Lodging](Misc%20Files/CLI/compendium/tables/food-drink-and-lodging.md)
...
Some of the most basic types of hirelings appear on the Services table. Other common hirelings include any of the wide variety of people who inhabit a typical town or city, when the adventurers pay them to perform a specific task. For example, a wizard might pay a carpenter to construct an elaborate chest (and its miniature replica) for use in the [Leomund's secret chest](Misc%20Files/CLI/compendium/spells/leomunds-secret-chest-xphb.md) spell. A fighter might commission a blacksmith to forge a special sword. A bard might pay a tailor to make exquisite clothing for an upcoming performance in front of the duke.
...
![](Misc%20Files/CLI/compendium/books/players-handbook-2014/img/c513.webp#center)

![Services](Misc%20Files/CLI/compendium/tables/services.md)

### Spellcasting Services

People who are able to cast spells don't fall into the category of ordinary hirelings. It might be possible to find someone willing to cast a spell in exchange for coin or favors, but it is rarely easy and no established pay rates exist. As a rule, the higher the level of the desired spell, the harder it is to find someone who can cast it and the more it costs.

Hiring someone to cast a relatively common spell of 1st or 2nd level, such as [cure wounds](Misc%20Files/CLI/compendium/spells/cure-wounds-xphb.md) or [identify](Misc%20Files/CLI/compendium/spells/identify-xphb.md), is easy enough in a city or town, and might cost 10 to 50 gold pieces (plus the cost of any expensive material components). Finding someone able and willing to cast a higher-level spell might involve traveling to a large city, perhaps one with a university or prominent temple. Once found, the spellcaster might ask for a service instead of payment—the kind of service that only adventurers can provide, such as retrieving a rare item from a dangerous locale or traversing a monster infested wilderness to deliver something important to a distant settlement.

## Trinkets

When you make your character, you can roll once on the [Trinkets](Misc%20Files/CLI/compendium/items/trinket-xphb.md) table to gain a trinket, a simple item lightly touched by mystery. The DM might also use this table. It can help stock a room in a dungeon or fill a creature's pockets.

![](Misc%20Files/CLI/compendium/books/players-handbook-2014/img/c514.webp#center)