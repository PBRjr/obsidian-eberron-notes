...
The [gate](Misc%20Files/CLI/compendium/spells/gate-xphb.md) spell is powerful, but not infallible. A deity, demon lord, or other powerful entity can prevent such a portal from opening within its dominion.
...
Traveling through the Astral Plane by means of the [astral projection](Misc%20Files/CLI/compendium/spells/astral-projection-xphb.md) spell involves projecting one's consciousness there, usually in search of a gateway to an Outer Plane to visit. Since the Outer Planes are as much spiritual states of being as they are physical places, this allows a character to manifest in an Outer Plane as if he or she had physically traveled there, but as in a dream.
...
![Astral Color Pools](Misc%20Files/CLI/compendium/tables/astral-color-pools.md)
...
![Psychic Wind](Misc%20Files/CLI/compendium/tables/psychic-wind.md)
...
![Deep Ethereal; Ethereal Curtains](Misc%20Files/CLI/compendium/tables/deep-ethereal-ethereal-curtains.md)
...
An ether cyclone is a serpentine column that spins through the plane. The cyclone appears abruptly, distorting and uprooting ethereal forms in its path and carrying the debris for leagues. Travelers with a passive Wisdom ([Perception](Misc%20Files/CLI/rules/skills.md#Perception)) score of 15 or more receive `1d4` rounds of warning: a deep hum in the ethereal matter.
...
![Ether Cyclones](Misc%20Files/CLI/compendium/tables/ether-cyclones.md)
...
Whenever a creature or group of creatures leaves the Feywild after spending at least 1 day on that plane, you can choose a time change that works best for your campaign, if any, or roll on the Feywild Time Warp table. A [wish](Misc%20Files/CLI/compendium/spells/wish-xphb.md) spell can be used to remove the effect on up to ten creatures. Some powerful fey have the ability to grant such wishes and might do so if the beneficiaries agree to subject themselves to a [geas](Misc%20Files/CLI/compendium/spells/geas-xphb.md) spell and complete a quest after the [wish](Misc%20Files/CLI/compendium/spells/wish-xphb.md) spell is cast.

![Feywild Time Warp](Misc%20Files/CLI/compendium/tables/feywild-time-warp.md)
...
![Shadowfell Despair](Misc%20Files/CLI/compendium/tables/shadowfell-despair.md)
...
A [calm emotions](Misc%20Files/CLI/compendium/spells/calm-emotions-xphb.md) spell removes despair, as does any spell or other magical effect that removes a curse.
...
![The Outer Planes](Misc%20Files/CLI/compendium/tables/the-outer-planes.md)
...
Traveling between the Outer Planes isn't dissimilar from reaching the Outer Planes in the first place. Characters traveling by means of the [astral projection](Misc%20Files/CLI/compendium/spells/astral-projection-xphb.md) spell can go from one plane into the Astral Plane, and there search out a color pool leading to the desired destination. Characters can also use plane shift to reach a different plane more directly. Most often, though, characters use portals-either a portal that links the two planes directly or a portal leading to Sigil, City of Doors, which holds portals to all the planes.
...
Visitors to the Beastlands find their hunting and stalking capabilities improved, and characters have advantage on Wisdom ([Animal Handling](Misc%20Files/CLI/rules/skills.md#Animal%20Handling)), Wisdom ([Perception](Misc%20Files/CLI/rules/skills.md#Perception)), and Wisdom ([Survival](Misc%20Files/CLI/rules/skills.md#Survival)) checks while there.
...
A visitor must make a DC 10 Wisdom saving throw after each hour spent among the howling winds. On a failed save, the creature gains one level of [exhaustion](Misc%20Files/CLI/rules/conditions.md#Exhaustion). A creature that reaches six levels of [exhaustion](Misc%20Files/CLI/rules/conditions.md#Exhaustion) while on this plane doesn't die. Instead, the creature gains a random form of indefinite madness, as described in chapter 8, "Running the Game." Finishing a long rest doesn't reduce a creature's [exhaustion](Misc%20Files/CLI/rules/conditions.md#Exhaustion) level unless the creature can somehow escape the maddening winds.
...
If a corrupted creature doesn't leave the plane within `1d4+2` days, its alignment changes to chaotic evil. Casting the [dispel evil and good](Misc%20Files/CLI/compendium/spells/dispel-evil-and-good-xphb.md) spell on the creature restores its original alignment.

![Optional Rule: Abyssal Corruption; Abyssal Corruption](Misc%20Files/CLI/compendium/tables/optional-rule-abyssal-corruption-abyssal-corruption.md)
...
At the end of each long rest taken on the plane, a visitor must make a DC 10 Wisdom saving throw. On a failed save, the creature gains one level of [exhaustion](Misc%20Files/CLI/rules/conditions.md#Exhaustion), which can't be removed while the creature remains in Hades. If the creature reaches six levels of [exhaustion](Misc%20Files/CLI/rules/conditions.md#Exhaustion), it doesn't die. Instead, the creature permanently transforms into a larva, whereupon all levels of [exhaustion](Misc%20Files/CLI/rules/conditions.md#Exhaustion) afflicting the creature are removed.
...
![The Outlands and Sigil; Gate-Towns of the Outlands](Misc%20Files/CLI/compendium/tables/the-outlands-and-sigil-gate-towns-of-the-outlands.md)
