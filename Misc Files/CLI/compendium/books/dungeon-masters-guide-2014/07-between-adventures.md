...
![Recurring Expenses; Maintenance Costs](Misc%20Files/CLI/compendium/tables/recurring-expenses-maintenance-costs.md)
...
- [Building a Stronghold](Misc%20Files/CLI/rules/variant-rules/downtime-activity-building-a-stronghold.md)  
- [Carousing](Misc%20Files/CLI/rules/variant-rules/downtime-activity-carousing.md)  
- [Crafting a Magic Item](Misc%20Files/CLI/rules/variant-rules/downtime-activity-crafting-a-magic-item.md)  
- [Gaining Renown](Misc%20Files/CLI/rules/variant-rules/downtime-activity-gaining-renown.md)  
- [Performing Sacred Rites](Misc%20Files/CLI/rules/variant-rules/downtime-activity-performing-sacred-rites.md)  
- [Running a Business](Misc%20Files/CLI/rules/variant-rules/downtime-activity-running-a-business.md)  
- [Selling Magic Items](Misc%20Files/CLI/rules/variant-rules/downtime-activity-selling-magic-items.md)  
- [Sowing Rumors](Misc%20Files/CLI/rules/variant-rules/downtime-activity-sowing-rumors.md)  
- [Training to Gain Levels](Misc%20Files/CLI/rules/variant-rules/downtime-activity-training-to-gain-levels.md)  
