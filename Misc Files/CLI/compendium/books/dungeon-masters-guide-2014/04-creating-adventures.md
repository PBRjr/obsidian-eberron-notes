...
![Identify the Party's Goals; Dungeon Goals](Misc%20Files/CLI/compendium/tables/identify-the-partys-goals-dungeon-goals.md)

![Identify the Party's Goals; Wilderness Goals](Misc%20Files/CLI/compendium/tables/identify-the-partys-goals-wilderness-goals.md)

![Identify the Party's Goals; Other Goals](Misc%20Files/CLI/compendium/tables/identify-the-partys-goals-other-goals.md)
...
![Identify Important NPCs; Adventure Villains](Misc%20Files/CLI/compendium/tables/identify-important-npcs-adventure-villains.md)

![Identify Important NPCs; Adventure Allies](Misc%20Files/CLI/compendium/tables/identify-important-npcs-adventure-allies.md)

![Identify Important NPCs; Adventure Patrons](Misc%20Files/CLI/compendium/tables/identify-important-npcs-adventure-patrons.md)
...
![Find the Ideal Introduction; Adventure Introduction](Misc%20Files/CLI/compendium/tables/find-the-ideal-introduction-adventure-introduction.md)
...
![Consider the Ideal Climax; Adventure Climax](Misc%20Files/CLI/compendium/tables/consider-the-ideal-climax-adventure-climax.md)
...
![Determine the Villain's Actions; Event-Based Villain Actions](Misc%20Files/CLI/compendium/tables/determine-the-villains-actions-event-based-villain-actions.md)
...
![Determine the Party's Goals; Event-Based Goals](Misc%20Files/CLI/compendium/tables/determine-the-partys-goals-event-based-goals.md)
...
![Framing Events](Misc%20Files/CLI/compendium/tables/framing-events.md)
...
![Moral Quandaries](Misc%20Files/CLI/compendium/tables/moral-quandaries.md)
...
![Twists](Misc%20Files/CLI/compendium/tables/twists.md)
...
![Side Quests](Misc%20Files/CLI/compendium/tables/side-quests.md)
...
![Combat Encounter Difficulty; XP Thresholds by Character Level](Misc%20Files/CLI/compendium/tables/combat-encounter-difficulty-xp-thresholds-by-character-level.md)
...
![Modify Total XP for Multiple Monsters; Encounter Multipliers](Misc%20Files/CLI/compendium/tables/modify-total-xp-for-multiple-monsters-encounter-multipliers.md)
...
![The Adventuring Day; Adventuring Day XP](Misc%20Files/CLI/compendium/tables/the-adventuring-day-adventuring-day-xp.md)
...
- The whole party is [surprised](Misc%20Files/CLI/rules/conditions.md#Surprised), and the enemy isn't.  
...
![Sylvan Forest Encounters](Misc%20Files/CLI/compendium/tables/sylvan-forest-encounters.md)
