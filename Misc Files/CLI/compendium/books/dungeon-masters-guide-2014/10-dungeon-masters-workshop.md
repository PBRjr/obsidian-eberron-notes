...
![Ability Check Proficiency by Class](Misc%20Files/CLI/compendium/tables/ability-check-proficiency-by-class.md)
...
Consider using the [Sanity score](Misc%20Files/CLI/rules/variant-rules/new-ability-scores-honor-and-sanity.md) if your campaign revolves around entities of an utterly alien and unspeakable nature, such as Great Cthulhu, whose powers and minions can shatter a character's mind.
...
![Explosives](Misc%20Files/CLI/compendium/tables/explosives.md)
...
![Figuring Out Alien Technology](Misc%20Files/CLI/compendium/tables/figuring-out-alien-technology.md)
...
![Speed Factor Initiative Modifiers](Misc%20Files/CLI/compendium/tables/speed-factor-initiative-modifiers.md)
...
- [Climb onto a Bigger Creature](Misc%20Files/CLI/rules/actions.md#Climb%20onto%20a%20Bigger%20Creature)  
- [Disarm](Misc%20Files/CLI/rules/actions.md#Disarm)  
- [Mark](Misc%20Files/CLI/rules/actions.md#Mark)  
- [Overrun](Misc%20Files/CLI/rules/actions.md#Overrun)  
- [Shove Aside](Misc%20Files/CLI/rules/actions.md#Shove%20Aside)  
- [Tumble](Misc%20Files/CLI/rules/actions.md#Tumble)  
...
![Lingering Injuries](Misc%20Files/CLI/compendium/tables/lingering-injuries.md)
...
![Massive Damage; System Shock](Misc%20Files/CLI/compendium/tables/massive-damage-system-shock.md)
...
- The creature is [surprised](Misc%20Files/CLI/rules/conditions.md#Surprised).  
...
- All the creatures in the group are [surprised](Misc%20Files/CLI/rules/conditions.md#Surprised).  
- The group's leader is reduced to 0 hit points, [incapacitated](Misc%20Files/CLI/rules/conditions.md#Incapacitated), taken prisoner, or removed from battle.  
...
![Creating Quick Monster Stats; Monster Statistics by Challenge Rating](Misc%20Files/CLI/compendium/tables/creating-quick-monster-stats-monster-statistics-by-challenge-rating.md)
...
![Final Challenge Rating; Experience Points by Challenge Rating](Misc%20Files/CLI/compendium/tables/final-challenge-rating-experience-points-by-challenge-rating.md)
...
![Assign Hit Dice; Hit Dice by Size](Misc%20Files/CLI/compendium/tables/assign-hit-dice-hit-dice-by-size.md)
...
![Damage Vulnerabilities, Resistances, and Immunities; Effective Hit Points Based on Resistances and Immunities](Misc%20Files/CLI/compendium/tables/damage-vulnerabilities-resistances-and-immunities-effective-hit-points-based-on-resistances-and-immunities.md)
...
If you want a monster to be proficient in a skill, you can give it a bonus equal to its proficiency bonus on ability checks related to that skill. For example, a monster with sharp senses might have a bonus on Wisdom ([Perception](Misc%20Files/CLI/rules/skills.md#Perception)) checks, while a duplicitous monster might have a bonus on Charisma ([Deception](Misc%20Files/CLI/rules/skills.md#Deception)) checks.

You can double the proficiency bonus to account for heightened mastery. For example, a doppelganger is so good at deceiving others that its bonus on Charisma ([Deception](Misc%20Files/CLI/rules/skills.md#Deception)) checks is equal to double its proficiency bonus + its Charisma modifier.
...
All monsters have a passive Wisdom ([Perception](Misc%20Files/CLI/rules/skills.md#Perception)) score, which is most often used to determine whether a monster detects approaching or hidden enemies. A monster's passive Wisdom ([Perception](Misc%20Files/CLI/rules/skills.md#Perception)) score is 10 + its Wisdom modifier. If the monster has proficiency in the Perception skill, its score is 10 + its Wisdom ([Perception](Misc%20Files/CLI/rules/skills.md#Perception)) bonus.
...
![Creating a Monster Stat Block; Monster Features](Misc%20Files/CLI/compendium/tables/creating-a-monster-stat-block-monster-features.md)
...
![Creating NPCs from Scratch; NPC Features](Misc%20Files/CLI/compendium/tables/creating-npcs-from-scratch-npc-features.md)
...
![Spell Damage](Misc%20Files/CLI/compendium/tables/spell-damage.md)
...
![Power Level; Magic Item Power by Rarity](Misc%20Files/CLI/compendium/tables/power-level-magic-item-power-by-rarity.md)
...
Filling in the remaining details, we end up with the following [racial traits for the aasimar](Misc%20Files/CLI/compendium/races/aasimar-xphb.md).
