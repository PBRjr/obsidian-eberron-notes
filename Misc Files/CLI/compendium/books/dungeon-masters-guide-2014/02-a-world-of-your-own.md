...
![A Sample Pantheon; Dawn War Deities](Misc%20Files/CLI/compendium/tables/a-sample-pantheon-dawn-war-deities.md)
...
![Forms of Government](Misc%20Files/CLI/compendium/tables/forms-of-government.md)
...
![Government; Sample Hierarchy of Noble Titles](Misc%20Files/CLI/compendium/tables/government-sample-hierarchy-of-noble-titles.md)
...
![Examples of Faction Ranks](Misc%20Files/CLI/compendium/tables/examples-of-faction-ranks.md)
...
![World-Shaking Events](Misc%20Files/CLI/compendium/tables/world-shaking-events.md)
...
![Rise or Fall of a Leader or an Era; Leader Types](Misc%20Files/CLI/compendium/tables/rise-or-fall-of-a-leader-or-an-era-leader-types.md)
...
![Cataclysmic Disasters](Misc%20Files/CLI/compendium/tables/cataclysmic-disasters.md)
...
![Assault or Invasion; Invading Forces](Misc%20Files/CLI/compendium/tables/assault-or-invasion-invading-forces.md)
...
![Extinction or Depletion](Misc%20Files/CLI/compendium/tables/extinction-or-depletion.md)
...
![New Organizations](Misc%20Files/CLI/compendium/tables/new-organizations.md)
...
![Discovery, Expansion, Invention; Discoveries](Misc%20Files/CLI/compendium/tables/discovery-expansion-invention-discoveries.md)
...
> 
> ![The Calendar of Harptos](Misc%20Files/CLI/compendium/tables/the-calendar-of-harptos.md)
...
Dedicated spellcasters learn 3rd-level spells at the start of this tier. Suddenly characters can fly, damage large numbers of foes with [fireball](Misc%20Files/CLI/compendium/spells/fireball-xphb.md) and [lightning bolt](Misc%20Files/CLI/compendium/spells/lightning-bolt-xphb.md) spells, and even breathe underwater. They master 5th-level spells by the end of the tier, and spells such as [teleportation circle](Misc%20Files/CLI/compendium/spells/teleportation-circle-xphb.md), [scrying](Misc%20Files/CLI/compendium/spells/scrying-xphb.md), [flame strike](Misc%20Files/CLI/compendium/spells/flame-strike-xphb.md), [legend lore](Misc%20Files/CLI/compendium/spells/legend-lore-xphb.md), and [raise dead](Misc%20Files/CLI/compendium/spells/raise-dead-xphb.md) can have a significant impact on their adventures. They start acquiring more permanent magic items (uncommon and rare ones) as well, which will serve them for the rest of their careers.
...
Dedicated spellcasters gain access to 6th-level spells at 11th level, including spells that completely change the way adventurers interact with the world. Their big, flashy spells are significant in combat-[disintegrate](Misc%20Files/CLI/compendium/spells/disintegrate-xphb.md), [blade barrier](Misc%20Files/CLI/compendium/spells/blade-barrier-xphb.md), and [heal](Misc%20Files/CLI/compendium/spells/heal-xphb.md), for example-but behind-the-scenes spells such as [word of recall](Misc%20Files/CLI/compendium/spells/word-of-recall-xphb.md), [find the path](Misc%20Files/CLI/compendium/spells/find-the-path-xphb.md), [contingency](Misc%20Files/CLI/compendium/spells/contingency-xphb.md), [teleport](Misc%20Files/CLI/compendium/spells/teleport-xphb.md), and [true seeing](Misc%20Files/CLI/compendium/spells/true-seeing-xphb.md) alter the way players approach their adventures. Each spell level after that point introduces new effects with an equally large impact. The adventurers find rare magic items (and very rare ones) that bestow similarly powerful abilities.
...
Dedicated spellcasters at this tier wield earthshaking 9th-level spells such as [wish](Misc%20Files/CLI/compendium/spells/wish-xphb.md), [gate](Misc%20Files/CLI/compendium/spells/gate-xphb.md), [storm of vengeance](Misc%20Files/CLI/compendium/spells/storm-of-vengeance-xphb.md), and [astral projection](Misc%20Files/CLI/compendium/spells/astral-projection-xphb.md). Characters have several rare and very rare magic items at their disposal, and begin discovering legendary items such as a [vorpal sword](Misc%20Files/CLI/compendium/items/vorpal-sword-xdmg.md) or a [staff of the magi](Misc%20Files/CLI/compendium/items/staff-of-the-magi-xdmg.md).
...
![Starting at Higher Level; Starting Equipment](Misc%20Files/CLI/compendium/tables/starting-at-higher-level-starting-equipment.md)
...
![Wuxia Weapon Names](Misc%20Files/CLI/compendium/tables/wuxia-weapon-names.md)
