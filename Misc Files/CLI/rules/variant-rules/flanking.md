...
A creature can't flank an enemy that it can't see. A creature also can't flank while it is [incapacitated](Misc%20Files/CLI/rules/conditions.md#Incapacitated). A Large or larger creature is flanking as long as at least one square or hex of its space qualifies for flanking.
