...
- Being subjected to spells that affect mental stability, such as the insanity option of the [symbol](Misc%20Files/CLI/compendium/spells/symbol-xphb.md) spell  
...
A failed Sanity save might result in [short-term](Misc%20Files/CLI/compendium/tables/short-term-madness.md), [long-term](Misc%20Files/CLI/compendium/tables/long-term-madness.md), or [indefinite madness](Misc%20Files/CLI/compendium/tables/indefinite-madness.md), as described in chapter 8, "Running the Game." Any time a character suffers from long-term or indefinite madness, the character's Sanity is reduced by 1. A [greater restoration](Misc%20Files/CLI/compendium/spells/greater-restoration-xphb.md) spell can restore Sanity lost in this way, and a character can increase his or her Sanity through level advancement.